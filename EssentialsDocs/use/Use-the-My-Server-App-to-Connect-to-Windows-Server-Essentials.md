...
description: Узнайте, как использовать мое серверное приложение для подключения к Windows Server Essentials.
ms.date: 10/03/2016
ms.topic: article
...
-   [Установка My Server](Use-the-My-Server-App-to-Connect-to-Windows-Server-Essentials.md#BKMK_Install)
...
-   **Доступ к сайтам и библиотекам групп SharePoint Online** — использование Microsoft 365 интеграции с Windows Server Essentials для доступа к сайтам групп SharePoint Online и открытия документов в библиотеках SharePoint Online на моем сервере 2012 R2.
...
##  <a name="operating-system-requirements"></a><a name="BKMK_OS"></a> Требования к операционной системе
...
2.  Установка сертификата
    ...
    7.  На странице мастера **хранения сертификатов** выберите **Поместить все сертификаты в следующее хранилище** и нажмите кнопку **Обзор**, чтобы выбрать хранилище **Доверенные корневые центры сертификации**. Нажмите кнопку **Готово**.

##  <a name="use-my-server"></a><a name="BKMK_UseServer"></a> Использовать мой сервер
...
###  <a name="features-of-my-server"></a><a name="BKMK_Features"></a> Функции моего сервера
...
|Использование библиотек SharePoint Online|(Только мой сервер 2012 R2) Работа с файлами в библиотеках SharePoint Online вашей команды. Открытие сайтов групп. (Раздел SharePoint Online: откройте сайт группы и ознакомьтесь с библиотекой документов или файлом, который вы хотите открыть. При открытии файла необходимо войти в Microsoft 365 с учетной записью Microsoft Online, связанной с вашей сетевой учетной записью.)<br /><br /> **Примечание.** Чтобы использовать эту функцию, сервер должен быть интегрирован с Microsoft 365, Подписка Microsoft 365 должна включать SharePoint Online, а учетной записи пользователя на сервере должна быть связана учетная запись Microsoft Online Services. Сведения об интеграции Microsoft 365 и SharePoint Online с Windows Server Essentials см. в разделе [Общие сведения об интеграции служб для Windows Server Essentials — часть 1](/archive/blogs/sbs/services-integration-overview-for-windows-server-2012-r2-essentials-part-1) и [службы Обзор интеграции для Windows Server Essentials — часть 2](/archive/blogs/sbs/services-integration-overview-for-windows-server-2012-r2-essentials-part-2).|
