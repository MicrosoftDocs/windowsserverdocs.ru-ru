...
description: Узнайте, как удаленные Веб-доступ позволяют получать доступ к файлам, папкам и компьютерам в сети через веб-браузер из любого места с подключением к Интернету.
ms.date: 10/03/2016
ms.topic: article
