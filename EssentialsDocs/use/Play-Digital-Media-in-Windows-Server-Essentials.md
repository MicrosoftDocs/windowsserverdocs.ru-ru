...
description: Узнайте, как Windows Server Essentials позволяет сетевым компьютерам и цифровым мультимедийным устройствам воспроизводить носители, хранящиеся на сервере.
ms.date: 10/03/2016
ms.topic: article
