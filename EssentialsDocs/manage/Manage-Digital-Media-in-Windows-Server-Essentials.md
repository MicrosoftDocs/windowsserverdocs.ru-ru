...
-   [Управление сервером мультимедиа с использованием панели мониторинга](Manage-Digital-Media-in-Windows-Server-Essentials.md#BKMK_2)
...
-   [Прекращение общего доступа к цифровому мультимедиа](Manage-Digital-Media-in-Windows-Server-Essentials.md#BKMK_9)

-   [Включение мультимедийных устройств, использующих протокол SMB для доступа к общим файлам на сервере](Manage-Digital-Media-in-Windows-Server-Essentials.md#BKMK_10)

-   [Стандартные программы обработки и поддерживаемые видеопрофили](Manage-Digital-Media-in-Windows-Server-Essentials.md#BKMK_CommonProcessors)

-   [Известные проблемы при работе с мультимедийными типами файлов](Manage-Digital-Media-in-Windows-Server-Essentials.md#BKMK_KnownIssues)
...
##  <a name="known-issues-with-media-file-types"></a><a name="BKMK_KnownIssues"></a> Известные проблемы с типами файлов мультимедиа
 Функция потоковой передачи мультимедиа в системе удаленного веб-доступа использует службу Windows Media Player 12 Network Sharing Service. Потоковая передача мультимедиа через удаленный веб-доступ поддерживает типы аудио-, видеофайлов и файлов изображений, которые поддерживаются Windows Media Player 12 и Silverlight 4.
