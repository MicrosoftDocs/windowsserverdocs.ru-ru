...
description: Узнайте, как использовать страницу Управление оперативной архивацией на панели мониторинга Windows Server Essentials для выполнения общих административных задач.
ms.date: 10/03/2016
ms.topic: article
...
-   [Загрузка сертификата в резервное хранилище Azure](Manage-Online-Backup-in-Windows-Server-Essentials.md#BKMK_1)

-   [Настройка оперативной архивации](Manage-Online-Backup-in-Windows-Server-Essentials.md#BKMK_2)

-   [Запуск оперативной архивации](Manage-Online-Backup-in-Windows-Server-Essentials.md#BKMK_3)

-   [Восстановление файлов и папок из резервных копий в Интернете](Manage-Online-Backup-in-Windows-Server-Essentials.md#BKMK_4)

-   [Регистрация сервера для архивации](Manage-Online-Backup-in-Windows-Server-Essentials.md#BKMK_5)
...
-   [Удаление или исключение резервных копий журнала файлов из политики оперативной архивации](Manage-Online-Backup-in-Windows-Server-Essentials.md#BKMK_10)
...
-   [Остановка начатой оперативной архивации сервера](Manage-Online-Backup-in-Windows-Server-Essentials.md#BKMK_12)

-   [Просмотр состояния оперативной архивации](Manage-Online-Backup-in-Windows-Server-Essentials.md#BKMK_13)

-   [Просмотр предупреждений оперативной архивации и управление ими](Manage-Online-Backup-in-Windows-Server-Essentials.md#BKMK_14)

-   [Сброс параметров оперативной архивации до значений по умолчанию](Manage-Online-Backup-in-Windows-Server-Essentials.md#BKMK_15)
...
4.  Установите Add-In Azure Backup на сервере.
...
####  <a name="install-the-azure-backup-add-in-on-the-server"></a><a name="BKMK_InstalltheWindowsAzureBackupAddIn"></a> Установка Add-In Azure Backup на сервере
...
3. На странице **Установка надстройки** щелкните **Установить надстройку**.
   ...
   >  Возможно, потребуется перезапустить сервер, чтобы установить требуемое ПО.
    ...
    Откроется страница **Установка**. После начала установки отображается индикатор хода установки. После завершения установки появится сообщение о том, что надстройка Azure Backup успешно установлена.
...
2.  [Загрузка сертификата в резервное хранилище Azure](Manage-Online-Backup-in-Windows-Server-Essentials.md#BKMK_1)

3.  [Регистрация сервера для архивации](Manage-Online-Backup-in-Windows-Server-Essentials.md#BKMK_5)

4.  [Настройка оперативной архивации](Manage-Online-Backup-in-Windows-Server-Essentials.md#BKMK_2)
