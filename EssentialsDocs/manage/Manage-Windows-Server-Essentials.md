...
description: Узнайте о возможностях управления сервером и сетью, которые входят в состав Windows Server Essentials.
ms.date: 10/03/2016
ms.topic: article
...
-   [Общие сведения о панели запуска](Overview-of-the-Launchpad-in-Windows-Server-Essentials.md)
...
-   [Управление цифровыми мультимедиа](Manage-Digital-Media-in-Windows-Server-Essentials.md)
