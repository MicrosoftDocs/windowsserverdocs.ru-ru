...
description: Узнайте, как просматривать все оповещения о работоспособности системы в сети и отвечать на них с помощью панели мониторинга.
ms.date: 10/03/2016
ms.topic: article
...
-   [Сведения о надстройке отчета о работоспособности](Manage-System-Health-in-Windows-Server-Essentials.md#BKMK_AddIn)
...
##  <a name="about-the-health-report-add-in"></a><a name="BKMK_AddIn"></a> Сведения о Add-In отчета о работоспособности
...
-   [Отправка отчета по электронной почте](Manage-System-Health-in-Windows-Server-Essentials.md#BKMK_emailreport)
...
-   Срок действия подписки на Microsoft 365 истек.

-   Не удалось Microsoft 365 проверку подлинности.

-   Неверная политика паролей.

-   Службе синхронизации паролей не удается синхронизировать пароль пользователя с Microsoft 365.

-   Изменение пароля Windows.

-   Пароль Microsoft 365 не совпадает с паролем Windows.
...
7.  Чтобы убедиться, что параметры SMTP-сервера правильно настроены для отправки отчетов о работоспособности по электронной почте, на вкладке Отчет о работоспособности на панели мониторинга выберите отчет и щелкните **Отправить отчет о работоспособности по электронной почте в** области задач.
...
|Не запущена одна или несколько служб.||
|Изменение пароля Windows.||
|Пароль Microsoft Microsoft 365 не совпадает с паролем Windows.||
