...
description: Узнайте, как включить удаленный Веб-доступ с помощью мастера настройки повсеместного доступа, а затем Узнайте, как настроить маршрутизатор и имя домена.
ms.date: 10/03/2016
ms.topic: article
...
-   [Раздел, посвященный настройке маршрутизатора](Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_2)

-   [Настройка имени домена](Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_3)

-   [Раздел о настройке удаленного веб-доступа](Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_4)

-   [Устранение неполадок удаленного веб-доступа](Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_5)

##  <a name="turn-on-and-configure-remote-web-access"></a><a name="BKMK_1"></a> Включение и настройка удаленного Веб-доступ
 Следующие разделы содержат сведения о включении и настройке удаленного веб-доступа:

-   [Раздел, содержащий обзор удаленного веб-доступа](Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_Overview)

-   [Раздел о включении удаленного веб-доступа](Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_TurnOnRWA)
...
-   [Раздел об обеспечении безопасности удаленного веб-доступа](Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_SecureRWA)

-   [Раздел об управлении пользователями удаленного веб-доступа и VPN](Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_ManageRWAVPN)
...
-   [Раздел, посвященный настройке маршрутизатора](Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_SetUpRouter)

-   [Раздел с информацией о замене маршрутизатора](Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_ReplaceRouter)

-   [Раздел, посвященный определению сетевого размещения](Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_NetworkLocation)
...
-   [Раздел, содержащий обзор имен доменов](Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_DNOverview)

-   [Раздел с общими сведениями о пользовательских именах доменов от Майкрософт](Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_PersonalizedNames)

-   [Раздел об использовании нового или существующего имени домена](Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_UseNewName)

-   [Раздел о настройке имени домена](Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_SetUpName)

-   [Раздел со сведениями о выборе поставщика службы доменных имен](Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_ChooseProvider)

-   [Раздел о выборе имени домена](Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_ChooseDomainName)
...
-   [Обновление службы доменных имен](Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_UpdateService)

-   [Раздел об экспорте или импорте сертификата на сервере](Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_ExportCert)

-   [Раздел, посвященный настройке имени домена вручную](Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_SetNameManually)
...
###  <a name="use-a-new-or-existing-domain-name"></a><a name="BKMK_UseNewName"></a> Использовать новое или существующее доменное имя
 ...
 **Расширение домена верхнего уровня** — это самая правая метка доменного имени. Например, в www \. contoso.com — это расширение доменного имени верхнего уровня.
...
###  <a name="find-your-domain-name-service-provider"></a><a name="BKMK_Find"></a> Поиск поставщика службы доменных имен
...
-   [Раздел о настройке удаленного веб-доступа](Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_CustomizeRWA)

-   [Раздел об индивидуальной настройке изображений для фона и эмблем](Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_CustomizeImages)

-   [Раздел, посвященный восстановлению удаленного веб-доступа](Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_RepairRWA)
