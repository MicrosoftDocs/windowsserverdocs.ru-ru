...
|Office 365|Вкладка **Office 365** отображается только в том случае, если Windows Server Essentials интегрирован с Microsoft 365. В этом разделе содержится информация о подписке Office 365 и учетной записи администратора.|
