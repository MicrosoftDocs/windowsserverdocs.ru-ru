...
description: Сведения о панели мониторинга администрирования, которая упрощает задачи, выполняемые для управления сетью и сервером Windows Server Essentials.
ms.date: 10/03/2016
ms.topic: article
