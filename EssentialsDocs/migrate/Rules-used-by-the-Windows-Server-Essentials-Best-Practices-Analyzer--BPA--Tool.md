...
### <a name="the-windows-server-microsoft-365-integration-service-is-not-set-to-use-the-local-system-account"></a>Служба интеграции Windows Server Microsoft 365 не настроена на использование локальной системной учетной записи
 **Вопрос.**  Служба интеграции Windows Server Microsoft 365 не настроена на использование учетной записи локальной системы в качестве учетной записи входа по умолчанию.
...
##### <a name="to-configure-the-microsoft-365-integration-service-to-use-local-system-as-the-default-logon-account"></a>Настройка службы интеграции Microsoft 365 на использование локальной системы в качестве учетной записи входа по умолчанию

1.  Откройте консоль "Службы".

2.  В списке служб дважды щелкните **службу интеграции Windows Server Microsoft 365**.
...
### <a name="the-windows-server-microsoft-365-integration-service-is-not-running"></a>Служба интеграции Windows Server Microsoft 365 не запущена
 **Вопрос.**  Служба интеграции Windows Server Microsoft 365 в данный момент не запущена.

 **Влияние:**  Если служба интеграции Windows Server Microsoft 365 не запущена, облачные функции Microsoft 365 недоступны.

 **Решение:**

##### <a name="to-start-the-windows-server-microsoft-365-integration-service"></a>Запуск службы интеграции Windows Server Microsoft 365
...
### <a name="the-startup-type-for-the-windows-server-microsoft-365-integration-service-is-not-set-to-automatic"></a>Для службы интеграции Windows Server Microsoft 365 не настроен автоматический тип запуска
 **Вопрос.**  Служба интеграции Windows Server Microsoft 365 может не запускаться, если для типа запуска не задано значение по умолчанию "автоматически".

 **Влияние:**  Если служба интеграции Windows Server Microsoft 365 не запущена, облачные функции Microsoft 365 недоступны.

 **Решение:**

##### <a name="to-configure-the-microsoft-365-integration-service-for-automatic-startup"></a>Настройка службы интеграции Microsoft 365 для автоматического запуска
