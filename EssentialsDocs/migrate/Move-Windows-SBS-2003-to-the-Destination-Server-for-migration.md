...
description: Узнайте, как перенести параметры и данные Windows SBS 2003 на целевой сервер для миграции Windows Server Essentials.
ms.date: 10/03/2016
ms.topic: article
...
3. [Удаление старых сценариев входа (необязательно)](#remove-old-logon-scripts)

4. [Удаление устаревших объектов групповой политики Active Directory (необязательно)](#remove-legacy-active-directory-group-policy-objects)
