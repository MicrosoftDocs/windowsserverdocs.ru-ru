...
description: Узнайте, как перенести стандартные параметры и данные Windows SBS 2011 на целевой сервер для миграции Windows Server Essentials.
ms.date: 10/03/2016
ms.topic: article
