...
description: Шаг 6. Узнайте, как понизить и удалить исходный сервер из новой сети Windows Server Essentials.
ms.date: 10/03/2016
ms.topic: article
...
1. [Удаление служб сертификатов Active Directory](#remove-active-directory-certificate-services)
...
4. [Удалите и заново настройте исходный сервер](#remove-and-re-purpose-the-source-server).

## <a name="remove-active-directory-certificate-services"></a>Удаление служб сертификатов Active Directory
...
7. Просмотрите информацию на странице **Подтверждение удаления** и нажмите кнопку **Удалить**.
    ...
    > [!NOTE]
    >  Если выполняются службы IIS, вам будет предложено остановить их перед продолжением. Нажмите кнопку **OK**.

    > [!NOTE]
    >  Сначала может потребоваться удалить **служба регистрации в центре сертификации через Интернет**, если он установлен.
