...
description: Узнайте, как перенести существующий домен Windows Server 2008 Foundation в Windows Server 2012 Essentials на новом оборудовании, а затем перенести параметры и данные.
ms.date: 10/03/2016
ms.topic: article
