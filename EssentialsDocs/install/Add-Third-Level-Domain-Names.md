...
description: Узнайте, как добавить возможность для пользователей запрашивать имена доменов третьего уровня в мастере настройки доменных имен.
ms.date: 10/03/2016
ms.topic: article
...
-   [Добавление в сборку реализации интерфейса IDomainMaintenanceProvider](Add-Third-Level-Domain-Names.md#BKMK_DomainMaintenance)
...
12. Введите **True** и нажмите кнопку **ОК**.
