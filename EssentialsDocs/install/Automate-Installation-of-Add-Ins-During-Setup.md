...
description: Узнайте, как использовать метод POST. cmd для автоматической установки надстроек во время установки Windows Server Essentials.
ms.date: 10/03/2016
ms.topic: article
