...
description: Узнайте, как установить Windows Server Essentials.
ms.date: 01/02/2017
ms.topic: article
...
-   [Размещение Windows Server Essentials Experience на виртуальных машинах Microsoft Azure](/previous-versions/azure/dn520828(v=azure.100)) (MSDN)
