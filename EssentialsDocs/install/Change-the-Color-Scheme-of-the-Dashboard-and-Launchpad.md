...
description: Узнайте, как изменить цветовую схему панели мониторинга и панель запуска, определив цвета, которые необходимо использовать в файле формата XML.
ms.date: 10/03/2016
ms.topic: article
