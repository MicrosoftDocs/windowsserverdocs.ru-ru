...
Дополнительные сведения об активации корпоративных лицензий для текущих и последних версий Windows см. в [этой статье](/windows/deployment/volume-activation/volume-activation-windows-10).
