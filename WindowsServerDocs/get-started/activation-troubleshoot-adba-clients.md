...
ms.openlocfilehash: 559ac010cf3be28e28047f4a2dd992db71cd1e41
ms.sourcegitcommit: 84b97d34d606b6bf4b6ec8760a93107f1b311428
ms.translationtype: HT
ms.contentlocale: ru-RU
ms.lasthandoff: 02/02/2021
ms.locfileid: "99245470"
---
...
![Снимок экрана: окно командной строки с командой slmgr /dlv и полученным сообщением об ошибке "Ключ продукта не найден".](./media/032618_1700_Troubleshoo4.png)
...
![Снимок экрана: окно командной строки с командой slmgr /ato и полученным сообщением об ошибке "Продукт не найден".](./media/032618_1700_Troubleshoo5.png)
...
![Снимок экрана: окно командной строки с командой slmgr /ato и полученным сообщением "Продукт успешно активирован".](./media/032618_1700_Troubleshoo11.png)

Еще раз воспользовавшись параметром **/dlv**, можно было увидеть, что мы выполнили активацию с помощью Active Directory.

![Снимок экрана: окно командной строки с командой slmgr/dlv и полученным сообщением о том, что пользователь активирован в Active Directory.](./media/032618_1700_Troubleshoo12.png)
...
![Снимок экрана: результаты выполнения команды slmgr /dlv с выделенными сведениями о канале RETAIL.](./media/032618_1700_Troubleshoo13.png)
...
![Снимок экрана: результаты выполнения команды slmgr /dlv с выделенными сведениями о канале VOLUME_KMSCLIENT.](./media/032618_1700_Troubleshoo14.png)
