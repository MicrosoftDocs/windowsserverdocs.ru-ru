...
| Твердотельный накопитель (SSD) | >емкости = 20 ГБ на станцию + 40 ГБ для операционной системы узла служб MultiPoint<p>Случайные операции ввода-вывода при чтении и записи >= 3K на станцию |
