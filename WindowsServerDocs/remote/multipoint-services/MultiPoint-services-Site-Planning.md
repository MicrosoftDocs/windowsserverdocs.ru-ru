...
![Станции последовательного опроса](./media/WMS_diagram5.gif)
...
![Несколько подключений нулевых клиентов USB](./media/WMS_diagram4.gif "WMS_diagram4")
...
## <a name="power-considerations"></a>Рекомендации по питанию
...
![Аудитория для лекций](./media/WMS_LectureRoom.gif)
