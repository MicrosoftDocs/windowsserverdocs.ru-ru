...
### <a name="ps2-stations"></a><a name="BKMK_PS2stations"></a>Станции PS/2
...
### <a name="split-screen-stations"></a>Станции с разделенным экраном
...
## <a name="station-type-comparison"></a><a name="BKMK_StationTypeComparison"></a>Сравнение типов станций

| Описание | Прямое подключение к видео | USB-клиент с нулевым подключением | Подключение RDP по локальной сети |
|--|--|--|--|
