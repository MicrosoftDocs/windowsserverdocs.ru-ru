...
- Улучшена поддержка использования редактора методов ввода в удаленном сеансе. Дополнительные сведения об использовании редактора методов ввода для веб-клиента см. в статье [Подключение к виртуальному рабочему столу Windows с помощью веб-клиента](/azure/virtual-desktop/connect-web.md).
