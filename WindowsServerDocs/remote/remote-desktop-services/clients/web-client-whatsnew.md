...
## <a name="updates-for-10240"></a>Обновления для версии 1.0.24.0
*Дата публикации: 06.01.2021*

>[!IMPORTANT]
> Версия 1.0.24.0 включает важное исправление безопасности. Мы удалили более ранние версии веб-клиента, содержащие эту ошибку. Рекомендуем всем клиентам как можно скорее выполнить обновление до версии 1.0.24.0. 

- Добавлена поддержка перенаправления входных данных с локального микрофона в удаленный сеанс.
- Устранены проблемы с **клавишей AltGr** и некоторые другие ошибки, касающиеся клавиатуры.
- Усовершенствованы специальные возможности.

## <a name="updates-for-10220"></a>Обновления для 1.0.22.0
*Дата публикации: 02.09.2020*

> [!IMPORTANT]
> В версии 1.0.22.0 мы представили регрессию, которая влияет на некоторые операционные системы Chromebook. Пользователи затронутых операционных систем не смогут подключиться к удаленному сеансу с помощью веб-клиента. Сейчас мы изучаем эту проблему и выпустим новую версию веб-клиента, как только мы исправим эту регрессию. Пока вы можете избежать этой проблемы, вернувшись к версии 1.0.21.0.

- Теперь пользователи могут перемещать свернутое меню.
- Улучшена поддержка сверхшироких мониторов и мониторов с разрешением 4K. Также исправлена проблема, из-за которой копирование большого объема данных приводило к аварийному завершению сеансов.
- Улучшена поддержка использования редактора методов ввода в удаленном сеансе. Дополнительные сведения об использовании редактора методов ввода для веб-клиента см. в статье [Подключение к виртуальному рабочему столу Windows с помощью веб-клиента](https://docs.microsoft.com/azure/virtual-desktop/connect-web).
- Изменен пользовательский интерфейс страницы **Все ресурсы**.
- Устранено несколько ошибок с последовательностью подключений. Из-за этих ошибок веб-клиент возвращал *общую ошибку протокола*.
- Исправлены проблемы с вводом с клавиатуры, из-за которых определенные сочетания клавиш не обрабатывались должным образом.
- Усовершенствованы специальные возможности.
