...
>[!IMPORTANT]
>Веб-клиент поддерживает использование прокси приложения Azure AD, но не поддерживает прокси-службу веб-приложения. Дополнительные сведения см. в разделе [С помощью служб удаленных рабочих столов с помощью служб прокси-сервера приложений](../rds-supported-config.md#using-remote-desktop-services-with-application-proxy-services).
...
>4. Выполните командлет **Install-Module RDWebClientManagement -RequiredVersion \<old version>, чтобы установить модуль более ранней версии.**
