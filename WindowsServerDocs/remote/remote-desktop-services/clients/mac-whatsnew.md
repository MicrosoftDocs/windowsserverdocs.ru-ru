...
- Исправлена проблема, когда у пользователя многократно запрашиваются учетные данные, если на сервере настроена расширенная защита для проверки подлинности.
