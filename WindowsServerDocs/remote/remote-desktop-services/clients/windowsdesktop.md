...
У вас есть предложение по компоненту или вы хотите сообщить о проблеме? Сообщите нам об этом в [Центре отзывов](https://aka.ms/rddesktopfeedback).

Вы также можете отправить нам отзыв, нажав в клиентском приложении кнопку, которая выглядит как смайлик с улыбающимся лицом, как показано на следующем рисунке:

> [!div class="mx-imgBorder"]
> ![Снимок экрана: смайлик с улыбающимся лицом для перехода в Центр отзывов.](../media/smiley-face-icon.png)
