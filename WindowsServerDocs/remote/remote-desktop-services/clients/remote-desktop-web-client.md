...
ms.openlocfilehash: 33cdbbc2b82f067d3b8d3a4ee88ebfd46ab5de7f
ms.sourcegitcommit: af9381b62f8ae6c78383ed6b81c37f843b5ad7e4
ms.translationtype: HT
ms.contentlocale: ru-RU
ms.lasthandoff: 02/16/2021
ms.locfileid: "100549350"
---
...
## <a name="web-client-keyboard-shortcuts"></a>Сочетания клавиш для веб-клиента
...
|-------------|------------|
|(Windows) CTRL+ALT+END</br>(MacOS) FN+CTRL+OPTION+DELETE|Внедряет CTRL+ALT+DEL в удаленном сеансе.|
...
Выполните следующие действия, чтобы использовать редактор метода ввода для ввода сложных символов в удаленном сеансе:

1. Щелкните значок шестеренки на панели навигации, чтобы открыть боковую панель **Параметры**.
2. Установите для переключателя **Включить редактор метода ввода** в значение **Вкл.**
3. Выберите предпочитаемую раскладку клавиатуры IME в раскрывающемся меню.

В удаленном сеансе должен быть установлен и включен редактор метода ввода.
