...
Каждый пользователь и устройство, подключающиеся к узлу сеанса Удаленного рабочего стола, должны иметь клиентскую лицензию (CAL). Лицензирование удаленных рабочих столов используется для установки, выдачи и отслеживания клиентских лицензий служб удаленных рабочих столов.
...
Существует льготный период лицензирования (180 дней), в течение которого сервер лицензирования не требуется. По окончании этого периода клиенты должны получить действительную клиентскую лицензию служб удаленных рабочих столов, выданную сервером лицензирования, без которой они не смогут войти на сервер узла сеансов удаленных рабочих столов.
