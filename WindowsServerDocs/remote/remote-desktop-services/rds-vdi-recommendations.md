...
|-------------------|----------|--------------|
|**Персонализация**| | |
|Выполнять персонализацию речи, ввода с клавиатуры и рукописного ввода, отправляя входные данные в Майкрософт.|    Включен| Off|
|Отправлять данные о вводе с клавиатуры и рукописном вводе в Майкрософт, чтобы улучшить платформу распознавания и предложений.|  Включен| Off|
|Позволить приложениям использовать ваш идентификатор получателя рекламы для работы с ними.|  Включен| Off|
|Разрешить Skype (если установлен) связываться с друзьями в вашей адресной книге и подтверждать номер вашего мобильного телефона. Может взиматься плата за SMS и передачу данных.|    Включен| Off|
|**Расположение**| | |
|Включить функцию "Поиск устройства" и разрешить Windows и приложениям запрашивать ваше расположение, включая историю расположений.| Включен| Off|
|Подключение и отчеты об ошибках.| | |
|Автоматически подключаться к предлагаемым открытым хот-спотам. Не все сети безопасны.|    Включен| Off|
|Автоматически временно подключаться к хот-спотам, чтобы узнать, доступны ли платные сетевые услуги.| Включен| Off|
|Отправлять полные диагностические данные и данные об использовании в Майкрософт. Если выключить этот параметр, будут отправляться только основные данные.| Включен| Off|
|**Браузер, защита и обновление**| | |
|Использовать веб-службы SmartScreen для защиты от вредоносного содержимого и скачивания на сайтах, загруженных с помощью браузеров Windows и приложений Store.|    Включен| Включено (если нет доступа в Интернет, установите значение "Отключено")
|Использовать прогнозирование страниц, чтобы настроить режим чтения, ускорить просмотр и в целом улучшить взаимодействие в браузерах Windows. Данные браузеров будут отправлены в Майкрософт.| Включен| Off|
|Получать обновления и отправлять их на другие ПК в Интернете, чтобы ускорить загрузку приложений и обновлений Windows.|   Включен| Off|
...
|Параметр|Значение по умолчанию|Рекомендуемое значение для использования VDI|
|-------------------|----------|--------------|
|Получать уведомления от приложений и других отправителей.| Включен| Off|
|Отображать уведомления на экране блокировки.|    Включен| Off|
|Отображать будильники, напоминания и входящие вызовы VoIP на экране блокировки.|   Включен| Off|
|Отображать советы, подсказки и предложения при использовании Windows.|    Включен| Off|
...
|Скрывать значки приложений на панели задач в режиме планшета|  Включен| Off|
...
|Параметр|Значение по умолчанию|Рекомендуемое значение для использования VDI|
|-------------------|----------|--------------|
|Использовать автозапуск для всех носителей и устройств|    Включен| Off|
...
1. Щелкните раскрывающееся меню в области **Фон**.
...
|Параметр|Значение по умолчанию|Рекомендуемое значение для использования VDI|
|-------------------|----------|--------------|
|Иногда показывать рекомендации в меню "Пуск"|    Включен| Off|
|Показывать наиболее часто используемые приложения|Включен|Off|
|Показывать недавно добавленные приложения|Включен|Off|
|Показывать последние открытые элементы в списках переходов в меню "Пуск" и на панели задач|Включен|Off|
...
|Параметр|Значение по умолчанию|Рекомендуемое значение для использования VDI|
|-------------------|----------|--------------|
|Позволить приложениям использовать мой идентификатор получателя рекламы (если отключить этот параметр, идентификатор будет сброшен)|  Включен| Off|
|"Разрешить веб-сайтам предоставлять местную информацию за счет доступа к моему списку языков"|Включен|Off|
|Разрешить приложениям на других устройствах открывать приложения и продолжать работу с ними на этом устройстве|Включен|Off|
...
||Consolidator|Включен|Отключен|
||KernelCeipTask|Включен|Отключен|
||UsbCeip|Включен|Отключен|
|Defrag||||
||ScheduledDefrag|Включен|Отключен|
|Расположение||||
||Уведомления|Включен|Отключен|
||WindowsActionDialog|Включен|Отключен|
|Обслуживание||||
||WinSAT|Включен|Отключен|
|Карты||||
||MapsToastTask|Включен|Отключен|
||MapsUpdateTask|Включен|Отключен|
|Учетные записи для широкополосного мобильного подключения||||
||Средство синтаксического анализа метаданных MNO|Включен|Отключен|
|Диагностика эффективности энергопотребления||||
||Анализ системы|Включен|Отключен|
|Среда восстановления||||
||VerifyWinRE|Включен|Отключен|
|Демонстрация розничной торговли||||
||CleanupOfflineContent|Включен|Отключен|
|Shell||||
||FamilySafetyMonitor|Включен|Отключен|
||FamilySafetyRefreshTask|Включен|Отключен|
|Отчеты об ошибках Windows||||
||QueueReporting|Включен|Отключен|
|Общий доступ к файлам мультимедиа Windows||||
||UpdateLibrary|Включен|Отключен|
...
||Запретить клиенту BITS использование кэша филиалов Windows|Включен|
||Запретить компьютеру действовать как клиенту кэширования членов одноранговой группы BITS|Включен|
||Запретить компьютеру действовать как серверу кэширования членов одноранговой группы BITS|Включен|
||Разрешить кэширование членов одноранговой группы BITS|Отключен|
|BranchCache||
||Включить BranchCache|Отключен|
|Проверка подлинности для территории беспроводного доступа||
||Включить проверку подлинности для территории беспроводного доступа|Отключен|
|Службы одноранговых сетей Майкрософт||
||Отключение служб одноранговых сетей Майкрософт|Включен|
|Автономные файлы||
||Разрешить или запретить использование автономных файлов|Отключен|
...
|-------------------|----------|--------------|
|Установка устройств||
||Не отправлять отчет об ошибках Windows, если на устройстве установлен универсальный драйвер|Включен|
||Не создавать контрольную точку восстановления системы во время работы устройства, при которой обычно требуется создание точки восстановления|Включен|
||Запретить получение метаданных устройств из Интернета|Включен|
||Запретить Windows отправлять отчет об ошибках, если драйвер устройства запрашивает дополнительное программное обеспечение в ходе установки|Включен|
||Отключить всплывающие напоминания "Найдено новое оборудование" во время установки устройства|Включен|
...
- Отключить центр справки и поддержки "Знаете ли вы?". Содержимое
...
||Запретить запускать мастер|Включен|
...
|Содержимое облака|||
||Отключение советов по использованию Windows|Включен|
||Выключение возможностей потребителя Microsoft|Включен|
...
||Отключение функций или параметров до выпуска|     Отключен|
||Запрет отображения уведомлений об отзывах|       Включен|
||Переключение пользовательских элементов управления над сборками для предварительной оценки|      Отключен|
|Диспетчер окон рабочего стола|||
||Не разрешать вызов эргономичного пролистывания|       Включен|
||Не разрешать анимацию окон|       Включен|
||Использовать сплошной цвет для фона начального экрана|     Включен|
|Пользовательский интерфейс границ|||
||Разрешить прокрутку от краев|     Отключен|
||Отключить полезные советы|        Включен|
|Проводник|||
||Не показывать уведомление "Установлено новое приложение"|     Включен|
|Обозреватель игр|||
||Выключить загрузку сведений об игре|     Включен|
||Отключить обновления игр|        Включен|
||Не отслеживать время последнего сеанса игр в папке "Игры"|     Включен|
|Домашняя группа|||
||Запретить присоединение компьютера к домашней группе|        Включен|
|Internet Explorer|||
||Разрешить службам Майкрософт предоставлять расширенные предложения, когда пользователь вводит текст в адресной строке|        Отключен|
||Отключить периодическую проверку наличия обновлений программного обеспечения Internet Explorer|        Включен|
||Отключить отображение заставки|        Включен|
||Устанавливать новые версии Internet Explorer автоматически|      Отключен|
||Запретить участие в программе улучшения качества программного обеспечения|     Включен|
||Не выполнять мастер запуска в первый раз. Перейти сразу на домашнюю страницу|   "Включено", а затем в раскрывающееся меню **Параметры** выберите **Перейти сразу на домашнюю страницу**|
||Задать рост процессов вкладок|Включите, а затем введите следующее в поле **Рост процессов вкладок**: *Низкое* —|
||Задать действие по умолчанию для новой вкладки|"Включено", а затем в раскрывающемся меню **Параметры** выберите **Страница новой вкладки**|
||Отключить уведомления о производительности надстроек|        Включен|
||Отключить функцию определения географического положения браузера|     Включен|
||Выключить повторное открытие последнего сеанса просмотра|        Включен|
||Выключить предложение для всех служб, установленных пользователем|        Включен|
||Turn on Suggested Site (Включить функцию "Рекомендуемые сайты")|       Отключен|
...
|-------------------|-------|----------|
|**Просмотр**|||
||Выключение определения номера телефона|Включен|
|**Мультимедиа**|||
||Разрешить Internet Explorer воспроизводить файлы мультимедиа, использующие альтернативные кодеки|Отключен|
...
- Отключение незапрошенного сетевого трафика на странице параметров "Автономные карты"
...
|-------------------|-------|----------|
|**OneDrive**|||
||Запрет использования OneDrive для хранения файлов|Включен|
||По умолчанию сохранять документы в OneDrive|Отключен|
|**RSS-каналы**|||
||Запретить автоматическое обнаружение веб-каналов и веб-фрагментов|Включен|
|**Поиск**|||
||Разрешение использовать Кортану|        Отключен|
||Разрешить использование Кортаны на экране блокировки|      Отключен|
||Разрешение средствам поиска и Кортане использовать информацию о расположении|     Отключен|
||Запрет на поиск в Интернете|      Включен|
||Запрет на поиск в Интернете и отображение результатов из Интернета в средстве поиска|        Включен|
||Не добавлять местоположения в формате UNC для индексирования с помощью панели управления|     Включен|
||Отключить индексирование файлов в кэше автономных файлов|        Включен|
|**Store**|||
||Выключить предложение обновления до последней версии Windows|Включен|
|**Отчеты об ошибках Windows**|||
||Автоматически отправлять дампы памяти для отчетов об ошибках, созданных ОС|       Отключен|
||Отключение отчетов об ошибках Windows|      Включен|
|**Установщик Windows**|||
||Задать максимальный размер кэша базисных файлов|  "Включено", а затем используйте счетчик в области **Параметры**, чтобы установить для параметра **Максимальный размер кэша базисных файлов** значение *5*.|
||Отключение создания контрольных точек восстановления системы|      Включен|
|**Почта Windows**|||
||Turn off the communities feature (Отключить функцию сообществ)|Включен|
|**Проигрыватель Windows Media**|||
||Запрет отображения диалоговых окон первого запуска|       Включен|
||Запрет общего доступа к файлам мультимедиа|        Включен|
|**Центр мобильности Windows**|||
||Отключить центр мобильности Windows|Включен|
|**Анализ стабильности Windows**|||
||Настройка поставщиков WMI стабильности системы|Отключен|
|**Клиентский компонент Центра обновления Windows**|||
||Разрешить немедленную установку автоматических обновлений|       Включен|
||Запретить использование любых средств Центра обновления Windows|     Включен|
|В папке **Центр обновления Windows** откройте **Defer Windows Update** (Отложить получение обновлений Windows)|||
||Выберите, когда следует получать обновления компонентов|"Включено", а затем в области **Параметры** в раскрывающемся меню **Выберите уровень готовности ветви для обновлений компонентов, которые вы хотите получать** выберите значение **Current Branch for Business**. Для счетчика **После выпуска обновления компонентов отложить его получение на столько дней** выберите значение *180 дней*.
||Выберите, когда следует получать исправления|"Включено", а затем в области **Параметры** выберите для счетчика **После выпуска исправления отложить его получение на столько дней** значение *30 дней* и установите флажок **Приостановить получение исправлений**.
...
|-------------------|-------|----------|
|**Рабочий стол**|||
||Не добавлять общие ресурсы из недавно использовавшихся документов в папку "Сетевые размещения"|Включен|
|В папке **Рабочий стол** откройте **Active Directory**|||
||Максимальный объем результатов поиска в Active Directory|"Включено", а затем в области **Параметры** выберите для счетчика **Число возвращаемых объектов** значение *5000*.|
|**Панель задач и меню ''Пуск''**|||
||Очистка списка недавно использовавшихся программ для новых пользователей|     Включен|
||Запрет на отображение и отслеживание элементов в списках переходов из удаленных расположений|        Включен|
||Отключить всплывающие уведомления объявлений компонентов|     Включен|
||Отключить слежение за действиями пользователя|       Включен|
...
|**Содержимое облака**|||
||Отключение всех функций "Windows: интересное"|Включен|
|**Проводник**|||
||Отключить кэширование эскизов изображений|       Включен|
||Отключить отображение предыдущих поисковых запросов в поле поиска проводника|        Включен|
||Отключить кэширование эскизов в скрытых файлах thumbs.db|      Включен|
...
1. В проводнике перейдите в каталог **C:\Windows\SoftwareDistribution\Download**.
