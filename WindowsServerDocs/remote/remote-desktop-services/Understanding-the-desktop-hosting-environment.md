...
Полное описание каждой из этих ролей и их взаимодействия друг с другом см. в статье [Общие сведения о ролях служб удаленных рабочих столов](./desktop-hosting-service.md).
...
Дополнительные сведения: [Документация по доменным службам Active Directory](https://azure.microsoft.com/documentation/services/active-directory-ds/)
...
Дополнительные сведения: [Что такое база данных SQL?](/azure/azure-sql/database/sql-database-paas-overview)
...
Дополнительные сведения: [Включение прокси приложения Azure AD](/azure/active-directory/manage-apps/application-proxy-add-on-premises-application)
...
Дополнительные сведения [Общие сведения о файловых службах и службах хранилища](/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/hh831487(v=ws.11))
[Как присоединить диск данных к виртуальной машине](https://www.windowsazure.com/manage/windows/how-to-guides/attach-a-disk/)
