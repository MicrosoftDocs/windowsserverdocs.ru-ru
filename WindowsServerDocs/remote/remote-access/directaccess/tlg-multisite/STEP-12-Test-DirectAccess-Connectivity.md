...
description: Узнайте, как убедиться, что клиентские компьютеры, расположенные в Интернете или Хоменет сети, имеют правильные параметры групповой политики.
manager: brianlic
ms.topic: article
...
1.  На компьютере КЛИЕНТ1 нажмите кнопку **Пуск**, введите **powershell.exe**, щелкните правой кнопкой мыши **PowerShell**, выберите пункт **Дополнительно** и нажмите кнопку **Запуск от имени администратора**. Если появится диалоговое окно **контроля учетных записей**, подтвердите, что отображаемое в нем действие именно то, которое требуется, и нажмите кнопку **Да**.
