...
description: Узнайте, как настроить инфраструктуру, необходимую для включения DirectAccess в существующем развертывании VPN.
manager: brianlic
ms.topic: article
...
![Windows PowerShell Windows PowerShell — ](../../../media/Step-1-Configure-the-DirectAccess-Infrastructure_3/PowerShellLogoSmall.gif) * *_<em>эквивалентные команды</em>_* _
