...
description: Узнайте, как установить и настроить RSA и EDGE1.
manager: brianlic
ms.topic: article
...
author: JasonGerend
ms.date: 08/07/2020
ms.openlocfilehash: 098b2a9e7b3e3a619fe8452c7e2bb6e54a35ae63
ms.sourcegitcommit: db4c35ebe56d561768d2a657da9e6d6a791457bd
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/04/2021
ms.locfileid: "101832627"
---
...
2.  Откройте папку установки К:\РСА и дважды щелкните **autorun.exe**.
...
10. В полях " **идентификатор пользователя** " введите " **Администратор**", а в поле **пароль** и **Подтверждение пароля** введите надежный пароль. Щелкните **Далее**.
...
7.  Назначьте Пользователь1 одному из импортированных токенов.
    ...
    8.  На странице " **распространение токена программного обеспечения** " в разделе " **файл загрузки** " щелкните **скачать сейчас**. Выберите команду **Сохранить**. Перейдите к К:\РСА установке и нажмите кнопку **сохранить** и **Закрыть**.
...
8.  Настройте диспетчер проверки подлинности в качестве сервера RADIUS.
    ...
    7.  Убедитесь, что отображается сообщение **"сервер RADIUS успешно настроен"** . Нажмите кнопку **Done**(Готово). Закройте **консоль управления RSA**.
...
10. Создайте файлы, необходимые для настройки EDGE1 в качестве агента проверки подлинности RSA.
    ...
    3.  Обратите внимание, что IP-адрес для EDGE1 теперь отображается в поле **IP-адрес** . Выберите команду **Сохранить**.
...
12. Создайте файл секрета узла для сервера EDGE1 (EDGE1_NodeSecret.zip).
    ...
    7.  Из \auth_mgr\windows-x86_64\am\rsa-ace_nsload\win32-5.0-x86\agent_nsload.exe копирования носителя диспетчера проверки подлинности RSA в установку К:\РСА.
...
5.  Нажмите кнопку **Далее** три раза, в разделе **Проверка подлинности** выберите **две факторы проверки подлинности** и **Используйте OTP** и убедитесь, что установлен флажок **использовать сертификаты компьютеров** . Убедитесь, что для корневого ЦС задано значение **CN = Corp-APP1-CA**. Щелкните **Далее**.
...
8.  В разделе **серверы ЦС OTP** выберите App1.Corp.contoso.com и нажмите кнопку **Добавить**. Щелкните **Далее**.
