...
7.  Назначьте Пользователь1 одному из импортированных токенов.
    ...
    8.  На странице " **распространение токена программного обеспечения** " в разделе " **файл загрузки** " щелкните **скачать сейчас**. Щелкните **Сохранить**. Перейдите к К:\РСА установке и нажмите кнопку **сохранить** и **Закрыть**.
...
10. Создайте файлы, необходимые для настройки EDGE1 в качестве агента проверки подлинности RSA.
    ...
    3.  Обратите внимание, что IP-адрес для EDGE1 теперь отображается в поле **IP-адрес** . Щелкните **Сохранить**.
