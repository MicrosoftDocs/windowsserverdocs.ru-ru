...
7.  Назначьте Пользователь1 одному из импортированных токенов.
    ...
    8.  На странице " **распространение токена программного обеспечения** " в разделе " **файл загрузки** " щелкните **скачать сейчас**. Нажмите **Сохранить**. Перейдите к К:\РСА установке и нажмите кнопку **сохранить** и **Закрыть**.
