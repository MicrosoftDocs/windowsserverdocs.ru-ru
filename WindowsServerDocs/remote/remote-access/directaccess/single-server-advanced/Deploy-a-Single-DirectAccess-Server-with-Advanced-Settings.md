...
description: Сведения о сценарии DirectAccess, в котором используется один сервер DirectAccess, и возможность развертывания DirectAccess с дополнительными параметрами.
manager: brianlic
ms.topic: article
...
author: JasonGerend
ms.date: 08/07/2020
ms.openlocfilehash: dc96412154ed6b9738d335a2155eb23175a4f140
ms.sourcegitcommit: db4c35ebe56d561768d2a657da9e6d6a791457bd
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/04/2021
ms.locfileid: "101831993"
---
