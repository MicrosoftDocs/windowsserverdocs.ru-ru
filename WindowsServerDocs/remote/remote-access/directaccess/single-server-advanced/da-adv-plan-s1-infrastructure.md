...
description: Узнайте, как спланировать инфраструктуру, необходимую для развертывания.
manager: brianlic
ms.topic: article
...
||**Рекомендуемые требования**<br/><br/>Общедоступный ЦС:<br/><br/>Рекомендуется использовать общедоступный ЦС для выдачи сертификата  IP-HTTPS. Это обеспечивает внешний доступ к точке распространения CRL.|
