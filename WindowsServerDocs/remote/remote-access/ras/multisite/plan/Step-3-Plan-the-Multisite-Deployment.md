...
description: Узнайте, как планировать дополнительные требования к сертификатам, как клиентские компьютеры выбирают точки входа и адреса IPv6, назначенные в развертывании.
manager: brianlic
ms.topic: article
...
author: JasonGerend
ms.date: 08/07/2020
ms.openlocfilehash: 9e9f2e2d654ecd1a3aea6f6f626c3777697bdd2d
ms.sourcegitcommit: db4c35ebe56d561768d2a657da9e6d6a791457bd
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/04/2021
ms.locfileid: "101803401"
---
...
1.  Для каждого объекта групповой политики, используемого для клиентских компьютеров Windows 10 или Windows 8, выполните командлет Set-DAEntryPointTableItem PowerShell.
