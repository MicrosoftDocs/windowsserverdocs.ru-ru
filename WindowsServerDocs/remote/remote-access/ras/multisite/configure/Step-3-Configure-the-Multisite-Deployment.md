...
description: Сведения о шагах, необходимых для настройки многосайтового развертывания для удаленного доступа.
manager: brianlic
ms.topic: article
...
![Windows PowerShell Windows PowerShell — ](../../../../media/Step-3-Configure-the-Multisite-Deployment/PowerShellLogoSmall.gif) * *_<em>эквивалентные команды</em>_* _
...
1.  На сервере удаленного доступа в дополнительной точке входа: на экране _ *Start** введите **Управление компьютером** и нажмите клавишу ВВОД.
...
1.  На имеющемся сервере удаленного доступа: на экране _ *Start** введите **RAMgmtUI.exe** и нажмите клавишу ВВОД. Если появится диалоговое окно **контроля учетных записей**, подтвердите, что отображаемое в нем действие именно то, которое требуется, и нажмите кнопку **Да**.
...
![](../../../../media/Step-3-Configure-the-Multisite-Deployment/PowerShellLogoSmall.gif)**_<em>Эквивалентные команды</em> в Windows PowerShell Windows PowerShell_**
