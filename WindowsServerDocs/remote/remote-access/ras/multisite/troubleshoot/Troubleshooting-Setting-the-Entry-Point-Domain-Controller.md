...
description: Узнайте, как устранять неполадки, связанные с командой Set-DAEntryPointDC.
manager: brianlic
ms.topic: article
...
Не указаны параметры *ентрипоинтнаме* или *ексистингдк* , или для командлета указаны оба параметра `Set-DaEntryPointDC` .
