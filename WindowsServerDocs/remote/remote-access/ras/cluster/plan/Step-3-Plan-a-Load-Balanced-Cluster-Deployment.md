---
title: Шаг 3. Планирование развертывания кластера Load-Balanced
description: Узнайте, как спланировать конфигурацию балансировки нагрузки и развертывание кластера.
manager: brianlic
ms.topic: article
...
Если вы используете веб-сайт сервера сетевых расположений на одном сервере удаленного доступа, во время развертывания выбрано использование сертификата, выданного внутренним центром сертификации (ЦС), или самозаверяющего сертификата.  Следует отметить следующее.
