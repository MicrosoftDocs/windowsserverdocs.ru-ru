...
Дополнительную информацию см. в разделе [Сервер политики сети (NPS)](../../../../networking/technologies/nps/nps-top.md).
...
Дополнительные сведения см. в разделе [шаблоны сертификатов](/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc730705(v=ws.11)).
...
Дополнительные сведения см. в разделе [Active Directory служб сертификации обзор](/previous-versions/windows/it-pro/windows-server-2012-r2-and-2012/hh831740(v=ws.11)).
...
- [Техническое руководство по Windows 10 VPN](/windows/access-protection/vpn/vpn-guide). в этом руководстве рассматриваются решения для клиентов Windows 10 в корпоративном VPN-решении и Настройка развертывания. В этом руководстве представлены ссылки на поставщик службы конфигурации (CSP) VPNv2 и инструкции для настройки решения управления мобильными устройствами (MDM) с помощью Microsoft Intune и шаблона профиля VPN для Windows 10.
...
- [Обзор служб сертификации Active Directory](/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/hh831740(v=ws.11)). в этом документе приведены общие сведения о службах сертификации Active Directory (AD CS) в Windows Server &reg; 2012. AD CS — это роль сервера, которая позволяет организации создать инфраструктуру открытых ключей (PKI) и использовать шифрование с открытым ключом, цифровые сертификаты и цифровые подписи.

- [Руководство по проектированию инфраструктуры открытых ключей](https://techcommunity.microsoft.com/t5/ask-the-directory-services-team/designing-and-implementing-a-pki-part-i-design-and-planning/ba-p/396953). Этот форум содержит рекомендации по проектированию инфраструктуры открытых ключей (PKI). Перед настройкой иерархии PKI и центра сертификации (ЦС) следует учитывать политику безопасности Организации и инструкции по сертификату (CPS).

- [Обзор служб сертификации Active Directory](/previous-versions/windows/it-pro/windows-server-2012-r2-and-2012/hh831740(v=ws.11)). в этом пошаговом руководстве описываются действия, необходимые для настройки базовой конфигурации &reg; служб сертификации Active Directory (AD CS) в лабораторной среде. Службы AD CS в Windows Server &reg; 2008 R2 предоставляют настраиваемые службы для создания сертификатов открытых ключей и управления ими, которые используются в системах безопасности программного обеспечения, использующих технологии открытого ключа.
