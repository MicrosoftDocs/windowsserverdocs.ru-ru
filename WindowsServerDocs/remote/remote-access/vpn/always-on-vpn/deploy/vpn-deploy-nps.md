...
7. Нажмите кнопку **OK**. VPN-сервер появится в списке клиентов RADIUS, настроенных на NPS-сервере.
...
6. В разделе Настройка методов проверки подлинности выполните следующие действия.
    ...
    5. Нажмите кнопку **Добавить**. Откроется диалоговое окно Добавление EAP.
