...
![Снимок экрана двух окон диспетчера задач, демонстрирующих использование ЦП на обеих виртуальных машинах шлюза RAS при наличии нескольких сеансов TCP.](../../media/GRE-Tunnel-Perf/Gre-Tunnel-01.jpg)
...
![Снимок экрана двух окон диспетчера задач, отображающих пропускную способность сети Ethernet на виртуальных машинах шлюза RAS при наличии нескольких сеансов TCP.](../../media/GRE-Tunnel-Perf/Gre-Tunnel-02.jpg)
...
![Снимок экрана двух окон диспетчера задач, демонстрирующих использование ЦП на обеих виртуальных машинах шлюза RAS при наличии одного сеанса TCP.](../../media/GRE-Tunnel-Perf/Gre-Tunnel-03.jpg)


На следующем рисунке показана пропускная способность сети Ethernet на виртуальных машинах шлюза RAS. Активная виртуальная машина, ВИРТУАЛЬная машина шлюза RAS #1, находится слева, а пассивная ВИРТУАЛЬная машина, ВИРТУАЛЬная машина шлюза RAS #2, находится справа.

![Снимок экрана двух окон диспетчера задач, отображающих пропускную способность сети Ethernet на виртуальных машинах шлюза RAS при наличии одного сеанса TCP.](../../media/GRE-Tunnel-Perf/Gre-Tunnel-04.jpg)
