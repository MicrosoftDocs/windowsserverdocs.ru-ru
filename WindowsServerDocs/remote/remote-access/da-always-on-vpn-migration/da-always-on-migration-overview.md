...
author: JasonGerend
ms.date: 05/29/2018
ms.openlocfilehash: 940349399e95417030910c3d84d462b61308410c
ms.sourcegitcommit: db4c35ebe56d561768d2a657da9e6d6a791457bd
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/04/2021
ms.locfileid: "101828353"
---
...
| Аутентификация  | Защищенная Расширенная проверка подлинности Protocol-Transport уровень безопасности (PEAP-TLS) с сертификатами пользователей, защищенными доверенный платформенный модуль (TPM) |
