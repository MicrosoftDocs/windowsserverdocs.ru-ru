...
-   [Правила списков ACL с отслеживанием состояния](#bkmk_stateful)

## <a name="detailed-acl-rules"></a><a name="bkmk_detailed"></a>Подробные правила списков ACL
...
-   [Применение политик безопасности на уровне пользователя и на уровне приложения](#bkmk_both)
...
### <a name="enforce-application-level-security"></a><a name="bkmk_enforce"></a>Применение политик безопасности на уровне приложения
...
### <a name="enforce-both-user-level-and-application-level-security"></a><a name="bkmk_both"></a>Применение политик безопасности на уровне пользователя и на уровне приложения
...
### <a name="provide-security-support-to-a-non-tcpudp-application"></a><a name="bkmk_tcp"></a>Обеспечение поддержки безопасности для приложения не TCP/UDP
...
## <a name="stateful-acl-rules"></a><a name="bkmk_stateful"></a>Правила списков ACL с отслеживанием состояния
