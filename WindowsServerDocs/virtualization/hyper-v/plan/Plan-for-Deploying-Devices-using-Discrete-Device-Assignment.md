...
Чтобы упростить определение правильности настройки сервера и доступность устройств, доступных для передачи с помощью дискретного назначения устройств, один из наших инженеров объединяет следующий сценарий PowerShell: [SurveyDDA.ps1.](https://github.com/Microsoft/Virtualization-Documentation/blob/live/hyperv-tools/DiscreteDeviceAssignment/SurveyDDA.ps1)
