...
|**Компонент**|**Версия операционной системы Windows Server**|**SLES 15 SP1**|**SLES 15**|**SLES 12 SP3-SP5**|**SLES 12 SP2**|**SLES 12 SP1**|**SLES 11 SP4**|**SLES 11 SP3**|
|-|-|-|-|-|-|-|-|-|
...
|Статическая Вставка IP-адресов|2019, 2016, 2012 R2|&#10004;Примечание 1|&#10004;Примечание 1|&#10004;Примечание 1|&#10004;Примечание 1|&#10004;Примечание 1|&#10004;Примечание 1|&#10004;Примечание 1|
...
|Динамическая Архивация виртуальных машин|2019, 2016, 2012 R2|&#10004; Примечание 2, 3, 8|&#10004;Примечание 2, 3, 8|&#10004; Примечание 2, 3, 8|&#10004; Примечание 2, 3, 8|&#10004; Примечание 2, 3, 8|&#10004; Примечание 2, 3, 8|&#10004; Примечание 2, 3, 8|
...
|Поддержка ядра PAE|2019, 2016, 2012 R2|Недоступно|Недоступно|Недоступно|Недоступно|Недоступно|&#10004;|&#10004;|
...
|Загрузка с помощью UEFI|2019, 2016, 2012 R2|&#10004; Примечание 9|&#10004; Примечание 9|&#10004; Примечание 9|&#10004; Примечание 9|&#10004; Примечание 9|&#10004; Примечание 9||
...
6. Если используется динамическая память в операционных системах Windows Server 2016 или Windows Server 2012, укажите **объем памяти при запуске**, **Минимальный объем памяти** и параметры **максимального объема памяти** (кратные 128 МБ). Несоблюдение этого действия может привести к Hot-Addм сбоям, и в операционной системе на виртуальной машине может не появиться никакого увеличения объема памяти.
