...
- Если вы используете роль узла удаленный рабочий стол сеансов или службы Windows MultiPoint на гостевой виртуальной машине, необходимо убедиться, что определенная запись групповая политика настроена на разрешение использования GPU по умолчанию. Используя групповая политика объект, применяемый к гостевой виртуальной машине (или редактор локальных групповых политик на гостевом компьютере), перейдите к следующему элементу групповая политика: **Конфигурация компьютера**  >  **шаблоны администратора**  >  **компоненты Windows**  >  **службы удаленных рабочих столов**  >  **Удаленный рабочий стол узел сеансов**  >  **Удаленный сеанс**  >  **использовать аппаратный адаптер по умолчанию для всех службы удаленных рабочих столов сеансов**. Установите для этого параметра значение включено, а затем перезагрузите виртуальную машину после применения политики.
