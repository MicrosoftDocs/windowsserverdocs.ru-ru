...
- Настройте виртуальный сетевой адаптер в режиме магистрали с помощью командлета [Set \- вмнетворкадаптервлан](/powershell/module/hyper-v/set-vmnetworkadaptervlan) .
