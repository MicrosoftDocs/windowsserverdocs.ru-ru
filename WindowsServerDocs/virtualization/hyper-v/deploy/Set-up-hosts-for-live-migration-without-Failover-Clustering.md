...
Для настройки динамической миграции на некластеризованные узлы доступны три командлета: [Enable-вммигратион](/powershell/module/hyper-v/enable-vmmigration), [Set-вммигратионнетворк](/powershell/module/hyper-v/set-vmmigrationnetwork)и [Set-vmhost](/powershell/module/hyper-v/set-vmhost). В этом примере используются все три и выполняется следующее:
