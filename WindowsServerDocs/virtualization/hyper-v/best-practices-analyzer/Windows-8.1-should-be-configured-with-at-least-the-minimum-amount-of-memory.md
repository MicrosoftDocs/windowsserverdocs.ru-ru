...
description: Узнайте, что делать, если для виртуальной машины, на которой работает Windows 8.1, настроено меньше минимального объема ОЗУ (512 МБ).
ms.author: benarm
