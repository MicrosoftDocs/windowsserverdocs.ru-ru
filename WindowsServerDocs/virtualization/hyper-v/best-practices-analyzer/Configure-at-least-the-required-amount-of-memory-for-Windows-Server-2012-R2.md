...
description: Узнайте, что делать, если одна или несколько виртуальных машин настроены для использования динамическая память с меньшим объемом памяти, требуемым для Windows Server 2012 R2.
ms.author: benarm
