...
description: Узнайте, что делать, если для виртуальной машины под Windows Server 2012 настроено меньше минимального объема ОЗУ (512 МБ).
ms.author: benarm
