...
description: Узнайте, что делать, если одна или несколько служб Integration Services отключены или не работают на виртуальной машине.
ms.author: benarm
