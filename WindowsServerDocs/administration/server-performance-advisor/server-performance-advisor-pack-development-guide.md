...
--- | --- | ---
SequenceId | Int, не NULL | Сопоставить строку и ее свойства
name | Nvarchar (1000) не равно NULL | Имя свойства
...
куерипас | FullPath | парентпас | FileName | Content
----- | ----- | ----- | ----- | -----
...
### <a name="sections"></a><a href="" id="bkmk-ui-section"></a>Священ
...
Дополнительные сведения об этих типах данных SQL см. в разделе [типы данных (Transact-SQL)](/sql/t-sql/data-types/data-types-transact-sql?view=sql-server-ver15).
...
|                                                                 Регистр символов в стиле Pascal                                                                 |                       "Верблюжий" стиль                        |             Верхний регистр             |
|-----------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|-----------------------------------|
...
--- | --- | ---
SequenceID | Int, не NULL | Идентификатор последовательности корреляции
name | Nvarchar (100) | Имя свойства
