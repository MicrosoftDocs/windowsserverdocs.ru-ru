...
Дополнительные сведения о PowerCfg.exe см. [в разделе Использование Powercfg для вычисления эффективности энергопотребления системы](/previous-versions/windows/hardware/download/dn550976(v=vs.85)).
...
Дополнительные сведения о схемах управления питанием и конфигурациях политик питания см. [в разделе Настройка и развертывание политики](/previous-versions/windows/hardware/design/dn642106(v=vs.85))управления питанием в Windows.
...
| 1 (включено) | Включено | Эффективность включена |
| 2 (агрессивно) | Включено | Aggressive |
