...
| Категория | Счетчик производительности | Интервал и выборка | целевого объекта | Предупреждение |
|--|--|--|--|--|
...
| Память | Логический *\<NTDS Database Drive\>* диск () \Авг чтения с диска (сек)<p>LogicalDisk ( *\<NTDS Database Drive\>* ) \Авг запись на диск (сек.) | 60 мин | 10 мс | 15 мс |
