...
### <a name="superseding-icon"></a>Значок замены
 ![icon](../../media/wsus/wsus-superseding.png) Это обновление заменяет другие обновления.
...
### <a name="superseded--superseding-icon"></a>Значок заменяемого &
 ![icon](../../media/wsus/wsus-superseded.png) Это обновление заменено другим обновлением и заменяет другие обновления.
...
### <a name="superseded-icon"></a>Значок «Заменено»
 ![icon](../../media/wsus/wsus-superseded-leaf.png) Это обновление заменено другим обновлением.
