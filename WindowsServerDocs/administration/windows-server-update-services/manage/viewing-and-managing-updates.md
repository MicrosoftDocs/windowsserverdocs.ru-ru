...
2.  В центральной области рядом с полем **утверждение** выберите состояние нужного утверждения, а затем рядом с полем **состояние** выберите нужное состояние установки. Нажмите кнопку **Обновить**.
...
3.  В нижней области отобразятся различные разделы свойств:
    ...
    -   В разделе Состояние отображается состояние установки обновления (компьютеры, на которых он должен быть установлен, компьютеры, на которых он был установлен, а также компьютеры, на которых оно было установлено или неприменимо, и на компьютерах, которые не сообщили о состоянии обновления), и об общих сведениях (KB и MSRC Numbers Release и т. д.).
...
Продукт — это конкретный выпуск операционной системы или приложения, например Windows Server 2012. Семейство продуктов представляет собой базовую операционную систему или приложение, от которых происходят отдельные продукты. Примером семейства продуктов является Microsoft Windows, членом которого является Windows Server 2012. Можно выбрать продукты или семейства продуктов, для которых сервер должен синхронизировать обновления. Можно указать семейство продуктов или отдельные продукты в семействе. При выборе любого продукта или семейства продуктов будут обновлены текущие и будущие версии продукта.
...
### <a name="superseding-icon"></a>Значок замены
 :::image type="icon" source="../../media/wsus/wsus-superseding.png"::: Это обновление заменяет другие обновления.
...
### <a name="superseded--superseding-icon"></a>Значок заменяемого &
 :::image type="icon" source="../../media/wsus/wsus-superseded.png"::: Это обновление заменено другим обновлением и заменяет другие обновления.
...
### <a name="superseded-icon"></a>Значок «Заменено»
 :::image type="icon" source="../../media/wsus/wsus-superseded-leaf.png"::: Это обновление заменено другим обновлением.
