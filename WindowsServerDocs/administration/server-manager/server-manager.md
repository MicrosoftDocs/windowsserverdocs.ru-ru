...
|Исходная операционная система диспетчер сервера|Нацелен на Windows Server 2016|Нацелен на Windows Server 2012 R2 |Нацелен на Windows Server 2012 |Нацелен на Windows Server 2008 R2 или Windows Server 2008 |Для Windows Server 2003|
|-------------------------------|--------------------------------------------|---------------------------------------|------------------------------------|-----------------------------------------------------------------------|------------------|
...
## <a name="start-server-manager"></a>Запуск диспетчер сервера
