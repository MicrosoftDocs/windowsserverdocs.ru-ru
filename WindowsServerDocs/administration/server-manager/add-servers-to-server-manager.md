...
Если вы выполнили процедуры, описанные в этом разделе, и вам не удается управлять компьютерами рабочей группы или управлять другими компьютерами с компьютеров рабочей группы, см. статью [about_remote_Troubleshooting](https://technet.microsoft.com/library/dd347642.aspx) на веб-сайте Майкрософт.
