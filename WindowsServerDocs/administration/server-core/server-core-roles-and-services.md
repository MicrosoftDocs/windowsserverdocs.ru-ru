...
| Hyper-V                                         | Hyper-V                        | Нет                     |
| Службы печати и документов                     | Печать — службы                 | Нет                     |
...
| Средства отказоустойчивости кластеров                              | RSAT — кластеризация                    | Нет                     |
...
| Служба настройки требуемого состояния Windows PowerShell | DSC — служба                        | Нет                     |
