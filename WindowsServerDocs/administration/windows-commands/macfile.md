...
manager: mtillman
ms.date: 10/16/2017
ms.openlocfilehash: 3064d3ea0e22e6cb4041efd2f1675a3fac0bb987
ms.sourcegitcommit: db4c35ebe56d561768d2a657da9e6d6a791457bd
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/04/2021
ms.locfileid: "101813156"
---
...
| /path`<directory>` | Указывает путь к каталогу, который необходимо изменить. Этот параметр обязателен. **Примечание.** Каталог должен существовать, но при использовании **каталога MacFile каталог** не создает каталоги. |
...
| -------- | --------------- |
| First | овнерсифилес |
| Second | овнерсифолдерс |
| Третье | овнермакечанжес |
...
| TargetFile`<filepath>` | Указывает расположение файла, созданного путем присоединения к вилке данных и вилки ресурса, или указывает расположение файла, тип или автор которого изменяется. Файл должен находиться на указанном сервере. Этот параметр обязателен. |
| /? | Отображение справки в командной строке. |
...
Чтобы создать файл *tree_app* на томе, доступном для Macintosh, с помощью Магнолиа ресурсов *к:\кросс\мак\аппкоде* и сделать этот новый файл доступным для клиентов Macintosh как приложение (приложения Macintosh используют тип " *приме*" *), указав* для создателя (Signature) значение , введите:
