...
- Для выполнения оценки не менее 4 секунд и не более 12 секунд с использованием размера буфера 32 МБ и сохранения результатов в формате XML в файл **memtest.xml**.
  ```
