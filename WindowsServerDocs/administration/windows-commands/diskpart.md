...
| [create](create.md) | Создает раздел на диске, том на одном или нескольких дисках или виртуальный жесткий диск (VHD). |
| [delete](delete.md) | Удаляет раздел или том. |
| [detach vdisk](detach-vdisk.md) | Останавливает отображение выбранного виртуального жесткого диска (VHD) в качестве локального жесткого диска на главном компьютере. |
| [detail](detail.md) | Отображает сведения о выбранном диске, разделе, томе или виртуальном жестком диске (VHD). |
| [exit](exit.md) | Выход из интерпретатора команд DiskPart. |
| [expand vdisk](expand-vdisk.md) | Расширение виртуального жесткого диска (VHD) до указанного размера. |
| [extend](extend.md) | Расширение тома или раздела с фокусом, а также его файловой системы на свободное (нераспределенное) пространство на диске. |
| [filesystems](filesystems.md) | Отображает сведения о текущей файловой системе тома, имеющего фокус, и перечисляет файловые системы, поддерживаемые для форматирования тома. |
...
| [online](online.md) | Принимает автономный диск или том в состояние "в сети". |
...
| [repair](repair.md) | Восстанавливает том RAID-5 с фокусом, заменяя неисправной регион диска на указанный динамический диск. |
| [rescan](rescan.md) | Находит новые диски, которые могли быть добавлены на компьютер. |
| [retain](retain.md) | Подготавливает существующий динамический простой том для использования в качестве загрузочного или системного тома. |
...
| [set id](set-id.md) | Изменяет поле "тип секции" для секции, имеющей фокус. |
...
- [Обзор управления дисками](../../storage/disk-management/overview-of-disk-management.md)
