...
ms.locfileid: "89030292"
---
# <a name="cprofile"></a>cprofile

Кпрофиле является устаревшим и не гарантируется поддержка в будущих выпусках Windows.

Службы терминалов были обновлены для службы удаленных рабочих столов. Дополнительные сведения см. в статье [Введение в службы удаленных рабочих столов](../../remote/remote-desktop-services/welcome-to-rds.md).
