---
title: eventtriggers
description: Справочная статья по команде EventTrigger. Эта команда устарела и не гарантируется, что она будет поддерживаться в будущих выпусках Windows.
ms.topic: reference
