...
> [!NOTE]
> В консоли восстановления можно также использовать команду **Format** с различными параметрами. Дополнительные сведения о консоли восстановления см. в разделе [Среда восстановления Windows (Windows RE)](/windows-hardware/manufacture/desktop/windows-recovery-environment--windows-re--technical-reference).
...
- [Условные обозначения синтаксиса команд командной строки](/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/cc771080(v=ws.11))
