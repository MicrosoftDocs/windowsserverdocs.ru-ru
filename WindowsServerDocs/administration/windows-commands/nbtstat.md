...
manager: mtillman
ms.date: 10/16/2017
ms.openlocfilehash: 6ab719159fb5b38e51aa4a2aad0b2dbdf2056781
ms.sourcegitcommit: db4c35ebe56d561768d2a657da9e6d6a791457bd
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/04/2021
ms.locfileid: "101811434"
---
...
- Возможные состояния подключения NetBIOS включают:
    ...
    | Исходящий трафик | Сеанс находится на этапе подключения и в данный момент создается подключение TCP. |
