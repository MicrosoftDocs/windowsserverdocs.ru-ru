---
title: prncnfg
description: Справочная статья по команде прнкнфг, которая настраивает или отображает сведения о конфигурации принтера.
ms.topic: reference
...
manager: mtillman
ms.date: 07/11/2018
ms.openlocfilehash: 85e7d547a8ec447df0e71acd62783440842d8b4b
ms.sourcegitcommit: db4c35ebe56d561768d2a657da9e6d6a791457bd
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/04/2021
ms.locfileid: "101808187"
---
...
| `{+|-}`служеб | Зарезервированная функция. |
