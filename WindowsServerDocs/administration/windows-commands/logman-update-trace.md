...
ms.locfileid: "89036352"
---
# <a name="logman-update-trace"></a>logman update trace

> Область применения: Windows Server (половина ежегодного канала), Windows Server 2019, Windows Server 2016, Windows Server 2012 R2, Windows Server 2012

Обновляет свойства существующего сборщика данных трассировки событий.
...
Чтобы обновить существующий сборщик данных трассировки событий, именуемый *trace_log*, измените максимальный размер журнала на 10 МБ, обновите формат файла журнала на CSV и добавьте управление версиями файлов в формате ммддххмм, введите:
...
- [команда logman Create Trace](logman-create-trace.md)
