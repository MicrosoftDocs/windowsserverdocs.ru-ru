...
Примеры добавления кластерных ролей см. в разделах [Add-ClusterFileServerRole](/powershell/module/failoverclusters/add-clusterfileserverrole) и [Add-ClusterGenericApplicationRole](/powershell/module/failoverclusters/add-clustergenericapplicationrole).
