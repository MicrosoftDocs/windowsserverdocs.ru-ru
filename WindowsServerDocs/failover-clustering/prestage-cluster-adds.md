...
>[!NOTE]
>Существует возможность создания кластера, отсоединенного Active Directory, где в AD DS не создаются CNO или VCO. Эта возможность предназначена для определенных типов развертывания кластера. Дополнительные сведения см. в разделе о [развертывании отсоединенного от Active Directory кластера](</previous-versions/windows/it-pro/windows-server-2012-r2-and-2012/dn265970(v%3dws.11)>).
