...
Scale-Out файловый сервер предназначен для предоставления масштабируемых файловых ресурсов, которые постоянно доступны для хранилища серверных приложений на основе файлов. Масштабируемые файловые ресурсы обеспечивают возможность совместного использования папок различными узлами одного кластера. Этот сценарий фокусируется на планировании и развертывании масштабируемого файлового сервера.
...
\*<a href="https://docs.microsoft.com/windows-server/storage/storage-spaces/cluster-sets#scale-out-file-server-and-cluster-sets">Постоянная доступность SMB замыкания на себя в конфигурациях с поддержкой Hyper-</a> in доступна в Windows Server 2019. 
...
<td>Отказоустойчивые кластеры добавили следующие функции в Windows Server 2012 для поддержки масштабируемого файлового сервера: имя распределенной сети, тип ресурса файлового сервера Scale-Out, общие тома кластера (CSV) 2 и роль высокой доступности Scale-Out файлового сервера. Дополнительные сведения об этих функциях см. в разделе новые <a href="/previous-versions/windows/it-pro/windows-server-2012-r2-and-2012/dn265972(v%3dws.11)">&#39;в отказоустойчивой кластеризации в Windows Server 2012 [перенаправлено]</a>.</td>
</tr>
<tr class="even">
