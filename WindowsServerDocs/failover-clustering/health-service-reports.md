---
description: 'Дополнительные сведения: служба работоспособности отчеты'
...
Для полной схемы изучите классы **MSFT \_ Сторажехеалсрепорт** и **MSFT \_ хеалсрекорд** в *сторажевми. mof*.
