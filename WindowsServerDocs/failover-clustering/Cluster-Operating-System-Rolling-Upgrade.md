...
description: 'Дополнительные сведения: последовательное обновление операционной системы кластера'
ms.topic: how-to
...
![Иллюстрация, демонстрирующая рабочий процесс обновления кластера ](media/Cluster-Operating-System-Rolling-Upgrade/Clustering_RollingUpgrade_Workflow.png)
...
2. Для каждого узла в кластере выполните следующие действия.
    ...
    3.  Переформатируйте системный диск и выполните чистую установку операционной системы Windows Server 2016 на узле, используя **настраиваемую установку: Установка только Windows (дополнительно)** (см. рис. 13) в setup.exe. Не устанавливайте флажок **обновление: установить Windows и не использовать файлы, параметры и приложения** , так как последовательное обновление ОС кластера не способствует обновлению на месте.
        ...
        ![Снимке экрана мастера установки Windows Server 2016, на котором показан вариант выборочной установки ](media/Cluster-Operating-System-Rolling-Upgrade/Cluster_RollingUpgrade_InstallOption.png)
    ...
    11. Для рабочих нагрузок Hyper-V используйте пользовательский интерфейс диспетчера Hyper-V, чтобы открыть диалоговое окно диспетчера виртуальных коммутаторов (см. рис. 14).
        ...
        ![Снимке экрана, где показано расположение диалогового окна диспетчера виртуальных коммутаторов Hyper-V ](media/Cluster-Operating-System-Rolling-Upgrade/Cluster_RollingUpgrade_VMSwitch.png)
