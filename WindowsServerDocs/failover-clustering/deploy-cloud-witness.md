...
3. На странице **Выбор конфигураций кворума** выберите **пункт выбрать следящий сервер кворума** (см. рис. 7).
    ...
    ![Моментальный снимок переключателя "выберите следящий сервер куотрум" в мастере кворума кластера ](media/Deploy-a-Cloud-Witness-for-a-Failover-Cluster/CloudWitness_8.png) **рис. 7. Выбор конфигурации кворума**
