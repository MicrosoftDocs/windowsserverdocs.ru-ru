...
**Azure Site Recovery** — это служба Azure, которая реплицирует рабочие нагрузки, работающие на виртуальных машинах, чтобы защитить вашу важную для предприятия инфраструктуру в случае сбоя.  Дополнительные [сведения о Azure Site Recovery](https://docs.microsoft.com/azure/site-recovery/site-recovery-overview).
...
- [Ознакомьтесь с инструментом планирования ресурсов, чтобы оценить требования к успешной репликации и отработке отказа](https://docs.microsoft.com/azure/site-recovery/hyper-v-site-walkthrough-capacity).
...
4. Ознакомьтесь с [требованиями к емкости для защиты виртуальной машины](https://docs.microsoft.com/azure/site-recovery/site-recovery-capacity-planner).
    ...
    Если вы хотите использовать учетную запись хранения класса Premium, [создайте ее на портал Azure](https://docs.microsoft.com/azure/storage/common/storage-premium-storage). Для создания стандартной учетной записи хранения используется параметр **Создать новую** на панели Windows Admin Center.
