...
> [!IMPORTANT]
> Некоторые функции, описанные в этой статье, доступны только в предварительной версии Windows Admin Center. [Разделы справки получить эту версию?](../overview.md)
