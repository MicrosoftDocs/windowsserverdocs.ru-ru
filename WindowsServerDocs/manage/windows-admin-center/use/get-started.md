...
2. Выберите Добавление сервера, кластера, компьютера Windows или виртуальной машины Azure.
   ...
   ![Центр администрирования Windows — страница "Добавление ресурсов"](../media/launch/ChooseConnectionType.png)
...
3. Введите имя сервера или кластера для управления и нажмите кнопку **Отправить**. Сервер или кластер будет добавлен в список подключений на странице "Обзор".
   ...
   ![Центр администрирования Windows — страница "серверы"](../media/launch/addserver2.png)
...
**Групповое импорт нескольких серверов**
 ...
 1. На странице **Добавление соединения с сервером** перейдите на вкладку **Импорт серверов** .
    ...
    ![Центр администрирования Windows — вкладка "Импорт серверов"](../media/launch/import-servers.png)
...
**Добавление серверов путем поиска Active Directory**
 ...
 1. На странице **Добавление соединения с сервером** перейдите на вкладку **Поиск Active Directory** .
    ...
    ![Центр администрирования Windows — вкладка "Поиск Active Directory"](../media/launch/search-ad.png)
...
![Все соединения, параметр "Управление как"](../media/launch-use-6.png)
...
![Страница "Указание учетных данных"](../media/launch-use-7.png)
...
![Центр администрирования Windows — параметр "изменить теги"](../media/launch/tags-5.png)
...
![Центр администрирования Windows — страница "изменение тегов подключения"](../media/launch/tags-6.png)
...
* Чтобы выполнить фильтрацию по тегу, щелкните значок фильтра рядом с полем поиска.
   ...
   ![Центр администрирования Windows — фильтрация с помощью поля поиска](../media/launch/tags-7.png)

   * Можно выбрать "или", "и" или "не", чтобы изменить поведение фильтра для выбранных тегов.

   ![Центр администрирования Windows — страница «фильтрация подключений»](../media/launch/tags-8.png)
