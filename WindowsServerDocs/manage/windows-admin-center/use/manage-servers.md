...
> [!NOTE]
> В центре администрирования Windows также можно добавить [отказоустойчивые кластеры](manage-failover-clusters.md) или [кластеры с поддержкой Hyper-](manage-hyper-converged.md) in в качестве отдельного подключения.
...
| [Файлы и общий доступ к файлам](#files-and-file-sharing) | Обзор файлов и папок |
...
| [Network](#network) | Просмотр и изменение сетевых устройств |
...
| [Реестр](#registry) | Просмотр и изменение записей реестра |
...
## <a name="files-and-file-sharing"></a>Файлы и общий доступ к файлам
...
[**Просмотр отзывов и предлагаемых функций для файлов и общего доступа к**](https://windowsserver.uservoice.com/forums/295071/filters/top?category_id=319162&query=%5BFiles%5D)файлам.
...
## <a name="scheduled-tasks"></a>Назначенные задания
...
[Обзор System Insights](../../system-insights/overview.md)
