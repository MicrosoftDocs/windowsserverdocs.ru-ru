...
Используйте двоеточия для представления списков. Например:

Выберите один из следующих вариантов.

Кошки собаки Куоккас
...
- Не нужно использовать тот же текст, что и в названии задачи; Используйте текст, который имеет смысл в контексте пользовательского интерфейса, но убедитесь в наличии логического соединения между ними. Например:
...
|Сведения из уведомления|Полные предложения, в идеале — с ссылкой на раздел в пользовательском интерфейсе, где отображается объект|

Вот некоторые подробные рекомендации для сообщений с уведомлениями.

|Тип строки         | Примечания                               |
|------------        |-------------------------------------|
|Запуск             |Опускайте по возможности — обычно можно просто перейти к сообщению о ходе выполнения, чтобы как можно меньше отвлекать.|
|Выполняется         |Начните с описания выполняемого действия и закончите многоточием, чтобы показать незавершенность операции. Ниже приведен пример.<br> *Создание тома "данные клиента"...* <br><br>При наличии нескольких переменных используйте следующий шаблон: <br>*Идет удаление следующей виртуальной машины: {0} ; Хост{1}* |
|Успешно             |Начните с наречия «Успешно» и закончите описанием только что завершенного действия. Ниже приведен пример.<br> *Тома "данные клиента" успешно созданы.*|
|Сбой             |Начните с «Не удалось» и закончите описанием действия, которое программному обеспечению выполнить не удалось. Ниже приведен пример.<br> *Не удалось создать том "данные клиента".*|
...
|    -----------------------                 |    -------------------------    |
|При отметке элемента управления или элемента пользовательского интерфейса...|Используйте простую, описательную фразу существительное. Например:<br> Выделение пера |
