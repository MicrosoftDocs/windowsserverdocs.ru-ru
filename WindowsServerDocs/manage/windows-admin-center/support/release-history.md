...
- Версия [2009](https://aka.ms/wac2009) — это последняя общедоступная версия. Она включает поддержку службы Azure Kubernetes на Azure Stack хЦи и основных обновлений для виртуальных машин, файловых ресурсов и средств контейнеров.
