...
ms.author: niwashbu
ms.date: 01/06/2020
ms.openlocfilehash: 30888c28d230dc136589f9c38bb8bb9b3091388d
ms.sourcegitcommit: db4c35ebe56d561768d2a657da9e6d6a791457bd
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/04/2021
ms.locfileid: "101824908"
---
...
- Версия [2103](https://aka.ms/wac2103) — это последний общедоступный выпуск. он содержит сведения об автоматическом обновлении платформы и включает обновления некоторых основных средств, таких как средства и события виртуальной машины.
- Версия [2009](https://aka.ms/wac2009) включает поддержку службы Azure Kubernetes на Azure Stack хЦи и основных обновлений для виртуальных машин, файловых ресурсов и средств контейнеров.
- Версия [2007](https://aka.ms/wac2007) включает поддержку новых Azure Stack хЦи и новых функций для нескольких средств.
- Версия [1910,2](https://aka.ms/wac1910.2) включает обновления специальных возможностей платформы и многочисленные исправления ошибок.
