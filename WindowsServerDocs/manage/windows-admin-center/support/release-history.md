...
- Версия [2007](https://aka.ms/wac2007) является последней версией общедоступного выпуска — она включает поддержку новых Azure Stack хЦи и новых функций для нескольких средств.
