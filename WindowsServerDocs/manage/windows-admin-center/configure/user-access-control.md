...
Вы также можете последовательно заполнять эти группы по всему домену, настраивая объект групповой политики с помощью параметра [Restricted Groups Policy Setting](/previous-versions/windows/it-pro/windows-server-2003/cc756802%28v=ws.10%29) (Настройка политики групп с ограниченным доступом).
