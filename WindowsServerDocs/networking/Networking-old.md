...
Документация DirectAccess теперь находится в разделе [Удаленный доступ и управление серверами](../remote/index.yml) оглавления Windows Server 2016 в разделе [Удаленный доступ](../remote/remote-access/remote-access.md). Дополнительные сведения см. в разделе [DirectAccess](../remote/remote-access/directaccess/DirectAccess.md).
...
Документация по удаленному доступа теперь находится в разделе [Удаленный доступ и управление серверами](../remote/index.yml) оглавления Windows Server 2016. Дополнительные сведения см. в разделе [Удаленный доступ](../remote/remote-access/remote-access.md).

Дополнительные сведения о прокси веб-приложения, который является службой роли сервера удаленного доступа, см. [в разделе прокси веб-приложения в Windows server 2016](../remote/remote-access/web-application-proxy/web-application-proxy-windows-server.md).
...
Дополнительные сведения см. в разделе [Руководство по развертыванию постоянно подключенной сети VPN удаленного доступа для Windows Server 2016 и Windows 10](../remote/remote-access/vpn/always-on-vpn/deploy/always-on-vpn-deploy.md).

>[!NOTE]
>Документация по VPN теперь находится в разделе [Удаленный доступ и управление серверами](../remote/index.yml) оглавления Windows Server 2016 в разделе [Удаленный доступ](../remote/remote-access/remote-access.md).

Дополнительные сведения о VPN см. в разделе [Виртуальная частная сеть (VPN)](../remote/remote-access/vpn/vpn-top.md).

### <a name="windows-container-networking"></a>[Сетевые подключения контейнеров Windows](/virtualization/windowscontainers/manage-containers/container-networking)
...
- [Обзор сетевого взаимодействия](/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/hh831357(v=ws.11)) в Windows Server 2012 и Windows Server 2012 R2
- [Возможности работы с сетями](/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc753940(v=ws.10)) в Windows Server 2008 и Windows Server 2008 R2
