---
description: 'Сведения по таким темам: Служба времени Windows'
...
## <a name="where-to-find-windows-time-service-configuration-information"></a><a name="BKMK_Config"></a>Поиск сведений о конфигурации службы времени Windows
...
## <a name="what-is-the-windows-time-service"></a><a name="BKMK_WTS"></a>Принцип работы службы времени Windows
...
## <a name="importance-of-time-protocols"></a><a name="BKMK_TimeProtocols"></a>Важность протоколов времени
...
[Как работает службы времени Windows](How-the-Windows-Time-Service-Works.md)
