...
| **Имя сети** |  **Подсеть**  | **Виде** | **ИД виртуальной ЛС в грузовике** | **Шлюз**  |                                                           **Резервирования (примеры)**                                                           |
|------------------|--------------|----------|----------------------|--------------|-------------------------------------------------------------------------------------------------------------------------------------------------|
...
- RFC 2545: "многопротокольные расширения BGP-4 для маршрутизации между доменами IPv6"
...
--------|-------------------------|-------------------------
|Физический узел Hyper-v|4-ядерный ЦП с частотой 2,66 ГГц<p>32 ГБ ОЗУ<p>300 ГБ дискового пространства<p>физический сетевой адаптер объемом 1 ГБ/с (или более мощный)|ОС: Windows Server 2016<p>Роль Hyper-V установлена|
