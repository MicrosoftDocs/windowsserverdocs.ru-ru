...
Если вы работаете с поставщиком облачных служб \( \) (CSP) или Enterprise, который планирует развертывать программно определенную сеть \( Sdn \) в Windows Server 2016, вы можете предоставить службы DNS для рабочих нагрузок размещенного клиента, используя внутренние DNS- \( IDNS \) , интегрированные с Sdn.
