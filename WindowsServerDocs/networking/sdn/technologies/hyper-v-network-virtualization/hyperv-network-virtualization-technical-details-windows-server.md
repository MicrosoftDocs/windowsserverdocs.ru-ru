...
-   **HNVv1**
    ...
    *   Установка Teaming и HNV v1 несовместима платформой.
    ...
    o чтобы использовать шлюзы HA NVGRE, пользователи должны либо использовать команду LBFO, либо не какую-либо команду. либо
