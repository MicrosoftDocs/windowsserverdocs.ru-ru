...
description: В этом разделе описывается развертывание инфраструктуры программно-определяемой сети (SDN) с помощью сценариев в Windows Server 2019 и 2016.
manager: grcusanz
ms.topic: how-to
...
Можно также развернуть инфраструктуру SDN с помощью диспетчер виртуальных машин (VMM). Дополнительные сведения см. [в разделе Настройка инфраструктуры программно-определяемой сети (SDN) в структуре VMM](/system-center/vmm/deploy-sdn).
...
На всех узлах Hyper-V должен быть установлен Windows Server 2019 или 2016.
