...
> - [Планирование SDN](/windows-server/networking/sdn/plan/Deploy-a-Software-Defined-Network-Infrastructure)
> - [Развертывание SDN](../deploy/deploy-a-software-defined-network-infrastructure.md)
> - [Управление SDN](../manage/manage-sdn.md)
> - [Безопасность в SDN](../security/sdn-security-top.md)

Этот раздел содержит следующие подразделы.

- [Диагностика стека программно-конфигурируемой сети Windows Server](./troubleshoot-windows-server-software-defined-networking-stack.md)
