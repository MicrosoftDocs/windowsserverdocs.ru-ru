...
description: С помощью этого раздела вы узнаете, как управлять сертификатами для сетевого контроллера обмена и Подсистемамми при развертывании программно-определяемой сети (SDN) в Windows Server 2019 и 2016 Datacenter.
manager: grcusanz
ms.topic: article
...
С помощью этого раздела вы узнаете, как управлять сертификатами для сетевого контроллера обмена и Подсистемамми при развертывании программно определяемой сети \( Sdn \) в Windows Server 2019 или 2016 Datacenter и использовать System Center Virtual Machine Manager \( SCVMM в \) качестве клиента управления Sdn.
...
Для создания самозаверяющего сертификата можно использовать команду Windows PowerShell [New-SelfSignedCertificate](/powershell/module/pkiclient/new-selfsignedcertificate) \- .
