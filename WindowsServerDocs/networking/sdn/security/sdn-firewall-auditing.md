...
Ниже приведен пример скрипта для включения аудита брандмауэра на узлах Hyper-V. Обновите переменные в начале и запустите его на компьютере с Windows Server 2019 с установленным компонентом RSAT-NetworkController:
