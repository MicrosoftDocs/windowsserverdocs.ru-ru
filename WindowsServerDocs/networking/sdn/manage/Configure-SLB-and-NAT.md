...
description: Узнайте, как использовать программно определенную сетевую подсистему балансировки нагрузки, чтобы обеспечить преобразование исходящего сетевого адреса, входящий трафик NAT или балансировку нагрузки между несколькими экземплярами приложения.
manager: grcusanz
ms.topic: article
...
## <a name="software-load-balancer-overview"></a>Общие сведения о ПО Load Balancer
