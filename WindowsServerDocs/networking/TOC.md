...
#### [Сетевой контроллер](/azure-stack/hci/concepts/network-controller-overview)
...
##### [Обзор брандмауэра центра обработки данных](/azure-stack/hci/concepts/datacenter-firewall-overview)
##### [Шлюз RAS-сервера для SDN](/azure-stack/hci/concepts/gateway-overview)
...
##### [Программная балансировка нагрузки для SDN](/azure-stack/hci/concepts/software-load-balancer)
...
### [План для SDN](/azure-stack/hci/concepts/plan-software-defined-networking-infrastructure)
#### [Требования к установке и подготовке для развертывания сетевого контроллера](/azure-stack/hci/concepts/network-controller)
...
##### [Управление потоком сетевого трафика центра обработки данных с помощью списка управления доступом](/azure-stack/hci/manage/use-datacenter-firewall-powershell)
...
##### [Настройка ACL брандмауэра центра обработки данных](/azure-stack/hci/manage/use-datacenter-firewall-powershell)
...
#### [Аудит брандмауэра SDN](/azure-stack/hci/manage/use-datacenter-firewall-powershell#firewall-auditing)
