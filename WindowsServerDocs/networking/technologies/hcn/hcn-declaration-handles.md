...
description: Сведения об ХКН сетевых сущностях, представленных с помощью дескрипторов контекста RPC HCN_NETWORK.
ms.author: daschott
author: daschott
ms.date: 11/05/2018
ms.topic: article
...
Сущности конечных точек ХКН представлены с помощью дескрипторов контекста RPC HCN_ENDPOINT.
...
Сущности пространства имен ХКН представлены с помощью дескрипторов контекста RPC HCN_NAMESPACE.
...
Сущности с подсистемой балансировки нагрузки ХКН представлены с помощью дескрипторов контекста RPC HCN_LOADBALANCER.
