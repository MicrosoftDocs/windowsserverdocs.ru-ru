...
description: Пример, в котором показано, как использовать API-интерфейс сетевой службы вычислений узла для создания сети вычислений узла на узле, который можно использовать для подключения виртуальных сетевых адаптеров к виртуальным машинам или контейнерам.
ms.author: daschott
author: daschott
ms.date: 11/05/2018
