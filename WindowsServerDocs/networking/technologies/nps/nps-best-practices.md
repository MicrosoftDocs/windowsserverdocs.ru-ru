...
- После установки и настройки сервера политики сети сохраните конфигурацию с помощью команды Windows PowerShell [Export-нпсконфигуратион](/powershell/module/nps/export-npsconfiguration?view=win10-ps). Сохраните конфигурацию NPS с помощью этой команды при каждой перенастройке NPS.
