...
- [Командлеты сервера политики сети (NPS) в Windows PowerShell](/powershell/module/nps/?view=win10-ps&viewFallbackFrom=winserverr2-ps). Эти команды Netsh можно использовать в операционных системах Windows Server 2012 R2 или более поздней версии.
- [Модуль NPS](/powershell/module/nps/?view=win10-ps). Эти команды Netsh можно использовать в Windows Server 2016.
