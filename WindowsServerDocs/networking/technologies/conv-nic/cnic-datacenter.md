...
author: JasonGerend
ms.date: 09/17/2018
ms.openlocfilehash: 03e84ca47b61b6f36db88ad0588a9b8e22a9dff9
ms.sourcegitcommit: db4c35ebe56d561768d2a657da9e6d6a791457bd
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/04/2021
ms.locfileid: "101828983"
---
...
1. Установите мосты центра обработки \( данных \) на каждом узле Hyper-V.
   ...
   | Успешное завершение | Требуется перезагрузка | Код завершения |     Результат функции     |
   |---------|----------------|-----------|------------------------|
   |  True   |       нет       |  Успешное завершение  | {Мост центра обработки данных} |
...
1. Создайте vSwitch в режиме SET на узле Hyper-V 1.
   ...
   |---------|------------|--------------------------------|
   | вмстест |  External  |        Teamed-Interface        |
