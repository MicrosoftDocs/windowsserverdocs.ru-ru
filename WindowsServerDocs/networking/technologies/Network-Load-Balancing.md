...
author: JasonGerend
ms.date: 09/13/2018
ms.openlocfilehash: 2333854f3723a06385d6c350b6bef541ca0846d1
ms.sourcegitcommit: db4c35ebe56d561768d2a657da9e6d6a791457bd
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/04/2021
ms.locfileid: "101833417"
---
...
-   Управление и настройка нескольких кластеров балансировки сетевой нагрузки и узлов кластера с одного компьютера с помощью диспетчера NLB или [командлетов балансировки сетевой нагрузки (NLB) в Windows PowerShell](/previous-versions/windows/powershell-scripting/hh801274(v=wps.630)).
