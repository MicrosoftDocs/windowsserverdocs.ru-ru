...
>Область применения: \( половина-годичный канал Windows Server \) , windows Server 2016
...
>[!IMPORTANT]
>Для всех рабочих сценариев используйте последние подписанные драйверы оборудования от изготовителя оборудования \( \) или независимого поставщика оборудования \( \) .
...
- [Переключить \( сценарии набора внедренных команд \)](#bkmk_set)
...
Дополнительные сведения см. в разделе [программно определяемая сеть &#40;SDN&#41;](sdn/software-defined-networking.md).
...
В сценариях, описанных в этом разделе, Сетевая группа Windows Server поддерживает использование любого сертифицированного драйвера Windows Server 2016. Обратитесь к производителю сетевого адаптера, \( \) чтобы убедиться в наличии последних обновлений драйверов.
...
Дополнительные сведения см. в статьях [Удаленный доступ к памяти &#40;RDMA&#41; и включение объединения внедренных &#40;SET&#41;](../virtualization/hyper-v-virtual-switch/RDMA-and-Switch-Embedded-Teaming.md).
...
Дополнительные сведения см. в разделе [Удаленный прямой доступ к памяти &#40;RDMA&#41; и коммутаторы внедренных команд &#40;SET&#41;](../virtualization/hyper-v-virtual-switch/RDMA-and-Switch-Embedded-Teaming.md)
...
### <a name="switch-embedded-teaming-set-scenarios"></a><a name="bkmk_set"></a>Переключить \( сценарии набора внедренных команд \)
