...
![Пример управления трафиком на основе Geo-Location](../../media/DNS-Policy-Geo1/dns_policy_geo1.png)
...
##  <a name="how-to-configure-dns-policy-for-geo-location-based-query-responses"></a><a name="bkmk_config"></a>Настройка политики DNS для ответов на запросы на основе Geo-Location
