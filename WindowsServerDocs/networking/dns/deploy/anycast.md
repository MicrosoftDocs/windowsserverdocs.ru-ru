...
![Произвольное DNS-имя](../../media/Anycast/anycast.png)
...
![Произвольное DNS-имя](../../media/Anycast/anycast-lab.png)
...
6.  Убедитесь, что сеанс BGP отключен от DC001 с помощью команды Get-Бгпстатистикс на сервере шлюза.
