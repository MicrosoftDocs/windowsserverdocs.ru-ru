...
- Проверьте наличие проблем на основном сервере, выполнив действия, описанные в разделе [Проверка проблем DNS-сервера](#check-dns-server-problems) . Когда появится запрос на выполнение задачи на клиенте, выполните задачу на сервере-получателе.
