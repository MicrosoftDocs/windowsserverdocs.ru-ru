...
В этом разделе содержится обзор основного сетевого руководства для Windows Server &reg; 2016 и приведены следующие разделы.

-   [Введение в концепцию основной сети Windows Server](#bkmk_intro)

-   [Основное сетевое руководством для Windows Server](#bkmk_core)

## <a name="introduction-to-the-windows-server-core-network"></a><a name="bkmk_intro"></a>Введение в концепцию основной сети Windows Server
...
Руководство по основным сетевым компонентам Windows Server 2016 содержит инструкции по планированию и развертыванию основных компонентов, необходимых для полностью работоспособной сети, а также нового &reg; домена Active Directory в новом лесу. Используя это руководство, можно развертывать компьютеры, на которых настроены следующие компоненты сервера Windows:
