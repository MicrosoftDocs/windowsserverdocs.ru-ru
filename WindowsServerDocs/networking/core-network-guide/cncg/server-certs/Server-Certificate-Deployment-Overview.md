...
description: Сведения о компонентах развертывания сертификатов сервера и процессе развертывания.
manager: brianlic
ms.topic: article
...
После создания папки в проводнике Windows необходимо настроить ее в качестве виртуального каталога в диспетчере службы IIS (IIS), а также для настройки списка управления доступом для виртуального каталога, чтобы разрешить компьютерам доступ к AIA и списку отзыва сертификатов после их публикации.
