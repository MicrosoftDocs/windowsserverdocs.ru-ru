...
description: Узнайте, как развернуть беспроводный доступ за пять шагов.
manager: brianlic
ms.topic: article
...
9. Нажмите **OK**. NAS появится в списке клиентов RADIUS, настроенных на сервере политики сети.
...
8.  Нажмите **OK**. Диалоговое окно Изменение защищенных свойств EAP закроется, и откроется мастер **настройки 802.1 x** . Щелкните **Далее**.
