...
description: Узнайте, как развертывать институт инженеров по электрическим и Электроникам, 802.1 с проверкой подлинности IEEE 802,11 с помощью защищенного протокола EAP, с использованием протокола проверки подлинности Microsoft Challenge версии 2.
manager: brianlic
ms.topic: article
...
### <a name="active-directory-domain-services-ad-ds"></a>Службы домен Active Directory \( AD DS\)
