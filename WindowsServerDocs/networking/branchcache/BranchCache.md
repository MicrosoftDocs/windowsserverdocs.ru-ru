...
author: JasonGerend
ms.date: 08/07/2020
ms.openlocfilehash: cb6a0d0639fae7c63e1de8e144cfbb93ad3cffb1
ms.sourcegitcommit: db4c35ebe56d561768d2a657da9e6d6a791457bd
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/04/2021
ms.locfileid: "101827995"
---
...
-   [Серверы содержимого с BranchCache](#BKMK_3)

-   [BranchCache и облако](#BKMK_3a)

-   [Версии сведений о содержимом](#bkmk_version)

-   [Обновление содержимого в файлах с помощью службы BranchCache](#bkmk_handles)
...
## <a name="branchcache-modes"></a><a name="BKMK_2"></a>Режимы BranchCache
...
## <a name="branchcache-enabled-content-servers"></a><a name="BKMK_3"></a>Серверы содержимого с BranchCache
...
При наличии серверов содержимого и размещенных серверов кэша, работающих под управлением Windows Server 2016, Windows Server 2012 R2 и Windows Server 2012, они используют соответствующую версию сведений о содержимом в зависимости от операционной системы клиента BranchCache, запрашивающего сведения.
...
## <a name="how-branchcache-handles-content-updates-in-files"></a><a name="bkmk_handles"></a>Обновление содержимого в файлах с помощью службы BranchCache
...
## <a name="branchcache-installation-guide"></a><a name="BKMK_4"></a>Руководство по установке BranchCache
...
|Функциональность|Расположение компьютера|Элемент BranchCache, который следует установить|
|-----------------|---------------------|------------------------------------|
|\(Сервер приложений на основе бит сервера содержимого\)|Главный офис или облачный центр обработки данных|Компонент BranchCache|
|\(Веб-сервер сервера содержимого\)|Главный офис или облачный центр обработки данных|Компонент BranchCache|
|\(Файловый сервер сервера содержимого по протоколу SMB\)|Главный офис или облачный центр обработки данных|Служба роли "Служба BranchCache для сетевых файлов" для роли сервера файловых служб|
|Сервер размещенного кэша|Филиал|Компонент BranchCache с включенным режимом сервера размещенного кэша|
|Клиентский компьютер с BranchCache|Филиал|Установка не требуется; просто включите BranchCache и режим BranchCache, \( распределенный или размещенный \) на клиенте.|
...
## <a name="operating-system-versions-for-branchcache"></a><a name="bkmk_os"></a>Версии операционных систем для BranchCache
...
## <a name="content-flow-and-processes"></a><a name="bkmk_flow"></a>Потоки сведений о содержимом и процессы
...
## <a name="branchcache-processes-locate-content"></a><a name="BKMK_9"></a>Процессы BranchCache: поиск содержимого
...
## <a name="branchcache-processes-cache-content"></a><a name="BKMK_11"></a>Процессы BranchCache: кэширование содержимого
