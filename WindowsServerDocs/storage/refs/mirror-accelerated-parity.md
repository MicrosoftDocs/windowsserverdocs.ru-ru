---
description: 'Дополнительные сведения: контроль четности с зеркальным отображением'
...
![Схема, изображающая зеркально отраженный объем четности.](media/mirror-accelerated-parity/Mirror-Accelerated-Parity-Volume.png)
...
![На схеме показан том с зеркальным отображением данных четности с помощью контейнеров хранилища.](media/mirror-accelerated-parity/Mirror-Accelerated-Parity-Volume-with-Storage-Containers.png)
...
![Анимация, демонстрирующая вращение четности с ускорением зеркального отображения.](media/mirror-accelerated-parity/Container-Rotation.gif)
...
1.  **Операции записи на уровень с зеркалированием:**
    ...
    ![Снимок экрана, показывающий, как служба ReFS выполняет запись в зеркальную копию.](media/mirror-accelerated-parity/Write-to-Mirror.png)
...
2. **Операции записи на уровень с зеркалированием, перенаправляемые с уровня с контролем четности:**
    ...
    ![Снимок экрана, показывающий, как служба ReFS выполняет запись в зеркальный режим, перераспределяется из четности.](media/mirror-accelerated-parity/Reallocated-Write.png)
...
3. **Операции записи на уровень с контролем четности:**
    ...
    ![Снимок экрана, показывающий, как служба ReFS выполняет запись в четность.](media/mirror-accelerated-parity/Write-to-Parity.png)
