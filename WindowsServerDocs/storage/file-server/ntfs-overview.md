...
Дополнительные сведения о функциях см. в [этом разделе](#additional-information) далее в этой статье. См. сведения о новой системе [Resilient File System (ReFS)](../refs/refs-overview.md).
...
## <a name="support-for-large-volumes"></a>Поддержка больших томов

NTFS может поддерживать тома размером до 8 ПБ в версии Windows Server 2019 и выше и Windows 10 версии 1709 и выше (более ранние версии поддерживают до 256 ТБ). Поддерживаемые размеры томов зависят от размера кластеров и их количества. Для кластеров (2<sup>32</sup> –1) (максимальное число кластеров, поддерживаемое NTFS) поддерживаются следующие размеры томов и файлов.
