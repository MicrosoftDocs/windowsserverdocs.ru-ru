...
## <a name="storage-replica-features"></a><a name="BKMK_SR2"> </a> Функции реплики хранилища
...
* По крайней мере 2 ГБ ОЗУ и два ядра на каждый сервер.
...
Командлет **Test-отработки отказа** , появилось в Windows Server, версии 1709 и также входит в windows Server 2019. Теперь поддерживается временное подключение моментального снимка для чтения и записи целевого тома для резервных копий, тестирования и т. д. https://aka.ms/srfaqДополнительные сведения см. в разделе.
