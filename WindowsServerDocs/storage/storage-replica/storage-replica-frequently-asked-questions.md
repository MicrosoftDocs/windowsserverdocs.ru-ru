---
description: 'Дополнительные сведения: часто задаваемые вопросы о реплике хранилища'
...
> ! МЕТИМ Для командлета Test-SRTopology требуется ICMPv4/ICMPv6, но не для репликации или управления.
