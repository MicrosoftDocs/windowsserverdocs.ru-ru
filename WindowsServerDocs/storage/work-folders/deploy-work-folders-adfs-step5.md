...
5. После проверки подлинности отображается страница **Знакомство с рабочими папками**, где вы можете изменить расположение каталога рабочих папок. Щелкните **Далее**.

6. На странице **Политики безопасности** перечислены политики безопасности, настроенные для рабочих папок. Щелкните **Далее**.

7. Отобразится сообщение о том, что рабочие папки начали синхронизацию с вашим компьютером. Щелкните **Закрыть**.
