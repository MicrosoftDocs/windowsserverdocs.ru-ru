---
description: 'Дополнительные сведения о развертывании рабочих папок с помощью AD FS и прокси веб-приложения: шаг 4, Настройка прокси веб-приложения'
...
6.  На странице подтверждения отображается команда Windows PowerShell, которая будет выполнена для настройки службы. Нажмите **Настроить**.
...
4. На странице Приветствие нажмите кнопку **Далее**.
