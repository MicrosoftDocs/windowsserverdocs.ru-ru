...
- Тип доступности
- Тип общего ресурса
- Режим перечисления папок *(Access-Based перечисление или ABE)*
- Режим кэширования
- Режим аренды
- Экземпляр SMB
- Время ожидания ЦС
...
- **Установите Последнее ежемесячное накопительное обновление.** Мы улучшили прокси-службу службы миграции хранилища в нескольких обновлениях, чтобы обеспечить более высокую производительность при переносе и повторном переносе, а также на производительность инвентаризации. Установите [накопительное обновление KB4580390 за октябрь 2020](https://support.microsoft.com/help/4580390/windows-10-update-kb4580390) или более поздней версии, чтобы добиться значительного улучшения скорости.
...
- **Настройка оборудования** Ознакомьтесь с [рекомендациями по настройке производительности для Windows server 2016](../../administration/performance-tuning/index.md) для настройки Orchestrator и конечных компьютеров под управлением windows Server 2019 и windows Server 2016. Раздел " [Настройка производительности сетевой подсистемы](../../networking/technologies/network-subsystem/net-sub-performance-tuning-nics.md) " содержит особенно ценные сведения.
...
Для получения поддержки:
 ...
 - Публикация на [форуме по Windows Server 2019](/answers/topics/windows-server-2019.html)
 - Откройте обращение в службу поддержки через [Служба поддержки Майкрософт](https://support.microsoft.com)
