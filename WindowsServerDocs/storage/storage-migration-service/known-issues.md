...
Это не обязательно происходит для всех исходных компьютеров. Мы работаем над диагностикой этой проблемы. В качестве обходного решения попробуйте найти обновление для средства службы миграции хранилища в центре администрирования Windows в ближайшее время. Обновление должно автоматически отображаться в веб-канале центра администрирования Windows и запрашивать установку, что позволит пропустить эту ошибку и продолжить.
