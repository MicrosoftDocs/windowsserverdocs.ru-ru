...
В этом разделе обсуждается, зачем использовать службу миграции хранилища, как работает процесс миграции, каковы требования к исходным и целевым серверам, а также [новые возможности службы миграции хранилища](#whats-new-in-storage-migration-service).
...
В центре администрирования Windows версии 1910 добавлена возможность развертывания виртуальных машин Azure. При этом развертывание виртуальной машины Azure интегрируется в службу миграции хранилища. Дополнительные сведения см. в статье [Миграция виртуальных машин Azure](#azure-vm-migration).
