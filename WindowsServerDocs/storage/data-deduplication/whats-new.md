---
description: Дополнительные сведения о новых возможностях дедупликации данных
...
| Функция | Новинка или обновление | Описание |
|---------------|----------------|-------------|
| [Поддержка больших томов](whats-new.md#large-volume-support) | Обновленные возможности | До выхода Windows Server 2016 приходилось подгонять размер тома к масштабу обработки, при этом том с размером больше 10 ТБ обычно не подходил для дедупликации данных. В Windows Server 2016 дедупликация данных поддерживает тома размером до 64 ТБ. |
| [Поддержка больших файлов](whats-new.md#large-file-support) | Обновленные возможности | До выпуска Windows Server 2016 файлы с размером около 1 ТБ обычно не подходили для дедупликации данных. В Windows Server 2016 файлы размером до 1 ТБ полностью поддерживаются. |
