...
1. **Есть ли в наборе данных рабочей нагрузки достаточный объем дублирующихся данных, чтобы включение дедупликации дало ощутимый эффект?**
    ...
    &nbsp;При выполнении DDPEval.exe будут возвращены выходные данные, аналогичные следующим: &nbsp;`Data Deduplication Savings Evaluation Tool`
...
![Щелкните файл и службы хранилища.](media/enable-dedup-via-server-manager-1.PNG)
