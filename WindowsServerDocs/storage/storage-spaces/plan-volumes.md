...
![На схеме показано, что представляют собой тома.](media/plan-volumes/what-are-volumes.png)
...
![Снимок экрана: окно проводника, в котором отображаются тома хранилища кластера.](media/plan-volumes/csv-folder-screenshot.png)
...
![На схеме показано понятие двустороннего хранилища данных с зеркальным отображением.](media/plan-volumes/two-way-mirror.png)
...
![Схема, описывающая концепцию вложенной контрольной суммы с зеркальным отображением.](media/nested-resiliency/nested-mirror-accelerated-parity.png)
...
![Схема, описывающая концепцию трехуровневого хранилища зеркальных данных.](media/plan-volumes/three-way-mirror.png)
...
![Схема, описывающая концепцию хранения данных с двойным контролем четности.](media/plan-volumes/dual-parity.png)
...
![Схема, показывающая, что размер тома должен помещаться в пуле носителей.](media/plan-volumes/size-versus-footprint.png)
...
![На схеме показано понятие резервной емкости.](media/plan-volumes/reserve.png)
...
![На схеме показан пример четырех томов, которые точно соответствуют емкости физического хранилища, доступной в пуле.](media/plan-volumes/example.png)
