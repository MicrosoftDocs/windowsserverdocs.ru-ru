---
description: См. Дополнительные сведения о кэше в Локальные дисковые пространства
...
<strong>Аспекты проектирования локальных дисковых пространств</strong><br>(20 минут)<br>
...
- [Выбор накопителей и типов устойчивости](choosing-drives.md)
