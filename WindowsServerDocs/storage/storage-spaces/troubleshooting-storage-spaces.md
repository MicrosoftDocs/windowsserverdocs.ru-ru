...
|------------|---------------------| -----------------| ------------| --------------|-----| --------------|
|Диск 4| Зеркальное отображение| ОК|  Работоспособно| Да|  10 ТБ|  Node-01. Конто...|
|Диск 3         |Зеркальное отображение                 |ОК                          |Работоспособно       |Да            |10 ТБ | Node-01. Конто...|
|Диск 2         |Зеркальное отображение                 |Без избыточности               |Unhealthy     |Да            |10 ТБ | Node-01. Конто...|
|Диск 1         |Зеркальное отображение                 |{Отсутствие избыточности, необслуживание}  |Unhealthy     |Да            |10 ТБ | Node-01. Конто...|
...
|Диск 4|         Зеркальное отображение|                 ОК|                  Работоспособно|       Да|            10 ТБ|  Node-01. Конто...|
|Диск 3|         Зеркальное отображение|                 ОК|                  Работоспособно|       Да|            10 ТБ|  Node-01. Конто...|
|Диск 2|         Зеркальное отображение|                 Отсоединен|            Неизвестно|       Да|            10 ТБ|  Node-01. Конто...|
|Диск 1|         Зеркальное отображение|                 Отсоединен|            Неизвестно|       Да|            10 ТБ|  Node-01. Конто...|
...
Вы можете получить событие 5120 с STATUS_IO_TIMEOUT c00000b5 после перезапуска узла в Windows Server 2016 с накопительным обновлением, выпущенным [8 мая, 2018 KB 4103723](https://support.microsoft.com/help/4103723) до [9 октября, 2018 KB 4462917](https://support.microsoft.com/help/4462917) .
...
## <a name="enable-clusterstoragespacesdirect-hangs-at-waiting-until-sbl-disks-are-surfaced-or-at-27"></a>Enable-ClusterStorageSpacesDirect зависает в ожидании, пока выводятся диски SBL или 27%
...
| EUI. 0100000001000000E4D25C000014E214 |    4     |    SSD    |  NVMe   | 0100_0000_0100_0000_E4D2_5C00_0014_E214. | 1600321314816  |  Да   |    СЕРВЕР     |   SSDPE2KE016T7   |
| EUI. 0100000001000000E4D25C000014E214 |    5     |    SSD    |  NVMe   | 0100_0000_0100_0000_E4D2_5C00_0014_E214. | 1600321314816  |  Да   |    СЕРВЕР     |   SSDPE2KE016T7   |
| EUI. 0100000001000000E4D25C0000EEE214 |    6     |    SSD    |  NVMe   | 0100_0000_0100_0000_E4D2_5C00_00EE_E214. | 1600321314816  |  Да   |    СЕРВЕР     |   SSDPE2KE016T7   |
| EUI. 0100000001000000E4D25C0000EEE214 |    7     |    SSD    |  NVMe   | 0100_0000_0100_0000_E4D2_5C00_00EE_E214. | 1600321314816  |  Да   |    СЕРВЕР     |   SSDPE2KE016T7   |
