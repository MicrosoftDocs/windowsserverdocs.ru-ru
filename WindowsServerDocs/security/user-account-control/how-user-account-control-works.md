...
description: Узнайте о контроле учетных записей пользователей (UAC) и о том, как она помогает предотвратить заражение компьютера вредоносными программами и помогает организациям развертывать более управляемую настольную систему.
ms.topic: article
...
manager: mtillman
ms.date: 10/12/2016
ms.openlocfilehash: c939d437fbd8961761ccab7aa840ad1811632ba3
ms.sourcegitcommit: db4c35ebe56d561768d2a657da9e6d6a791457bd
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/04/2021
ms.locfileid: "101832309"
---
...
### <a name="the-uac-user-experience"></a>Взаимодействие с пользователем UAC
