...
##### [Использование VMM](/system-center/vmm/guarded-deploy-host?toc=%2fwindows-server%2fvirtualization%2ftoc.json)
...
## [Отключение служб для отдельных пользователей в Windows](/windows/application-management/per-user-services-in-windows)
...
### [Защита учетных данных удаленного рабочего стола с помощью Remote Credential Guard](/windows/security/identity-protection/remote-credential-guard)
