...
| **Тип запуска** | Вручную |
| **Рекомендации** | Можно отключить |
| **Комментарии** | Можно отключить, если не используется. Еще один механизм отключения: [Отключение Bluetooth и инфракрасной передачи](/previous-versions/tn-archive/dd252791(v=technet.10)) |
