...
description: Дополнительные сведения о экранированных виртуальных машинах для клиентов. Создание данных экранирования для определения экранированной виртуальной машины
ms.topic: article
...
Сведения о получении и использовании функции **New-шиелдингдатаансверфиле** для создания файла ответов (Unattend.xml файл) для создания экранированных виртуальных машин см. в разделе [Создание файла ответов с помощью функции New-ShieldingDataAnswerFile](guarded-fabric-sample-unattend-xml-file.md). С помощью функции можно легко создать файл ответов, который будет включать следующие варианты:
...
- [Настройка пулов статических IP-адресов в структуре VMM](/system-center/vmm/network-pool)
...
В качестве альтернативы мастеру файлов данных экранирования можно выполнить команду [New-шиелдингдатафиле](/powershell/module/shieldedvmdatafile/new-shieldingdatafile) , чтобы создать файл данных экранирования.
...
Вы можете проверить, установлены ли какие-либо защитники локально, выполнив [Get-хгсгуардиан](/powershell/module/hgsclient/get-hgsguardian). Опекуны владельца имеют закрытые ключи, а опекуны для центра обработки данных обычно не используются.
...
> [!TIP]
> Если вы использовали самозаверяющие сертификаты или сертификаты, зарегистрированные в службе HGS, просрочены, может потребоваться использовать `-AllowUntrustedRoot` флаги и/или `-AllowExpired` с командой Import-HgsGuardian, чтобы обойти проверку безопасности.
...
Сведения о дополнительных способах настройки файла данных экранирования см. в документации по командлетам [New-шиелдингдатафиле](/powershell/module/shieldedvmdatafile/new-shieldingdatafile) и [New-волумеидкуалифиер](/powershell/module/shieldedvmdatafile/New-VolumeIDQualifier) .
