...
- [Настройка пулов статических IP-адресов в структуре VMM](/system-center/vmm/network-pool?view=sc-vmm-2019)
...
В качестве альтернативы мастеру файлов данных экранирования можно выполнить команду [New-шиелдингдатафиле](/powershell/module/shieldedvmdatafile/new-shieldingdatafile?view=win10-ps) , чтобы создать файл данных экранирования.
...
Вы можете проверить, установлены ли какие-либо защитники локально, выполнив [Get-хгсгуардиан](/powershell/module/hgsclient/get-hgsguardian?view=win10-ps). Опекуны владельца имеют закрытые ключи, а опекуны для центра обработки данных обычно не используются.
...
Сведения о дополнительных способах настройки файла данных экранирования см. в документации по командлетам [New-шиелдингдатафиле](/powershell/module/shieldedvmdatafile/new-shieldingdatafile?view=win10-ps) и [New-волумеидкуалифиер](/powershell/module/shieldedvmdatafile/New-VolumeIDQualifier?view=win10-ps) .
