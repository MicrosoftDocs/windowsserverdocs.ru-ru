...
Полную документацию по командлетам, используемым в этой статье, можно найти в [справочнике по модулю хгсдиагностикс](https://docs.microsoft.com/powershell/module/hgsdiagnostics/?view=win10-ps).
