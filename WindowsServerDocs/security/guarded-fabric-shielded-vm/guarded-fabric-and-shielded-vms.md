---
description: См. Дополнительные сведения о защищенной структуре и экранированных виртуальных машинах
...
|Последовательные или COM-порты   | Поддерживаются:                             | Отключено (не может быть включено) |
|Подключение отладчика (к процессу виртуальной машины)<sup>1</sup>| Поддерживаются:          | Отключено (не может быть включено) |
