...
![Иллюстрация, на которой показан файл данных экранирования и связанные элементы конфигурации.](../media/Guarded-Fabric-Shielded-VM/shielded-vms-shielding-data-file.png)
