---
description: Дополнительные сведения о экранированных виртуальных машинах для клиентов. Создание диска шаблона (необязательно)
...
9. На странице **Сводка** сведения о шаблоне диска, сертификате, используемом для подписи шаблона, и отображается издатель сертификата. Нажмите кнопку **Закрыть**, чтобы выйти из мастера.
