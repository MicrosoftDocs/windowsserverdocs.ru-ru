...
description: Дополнительные сведения о развертывании службы защиты узла
ms.topic: article
...
| 9. [Настройка VMM (необязательно)](/system-center/vmm/deploy-guarded-host-fabric) | ![Шаг 9. Настройка VMM (необязательно)](../media/Guarded-Fabric-Shielded-VM/guarded-host-configure-vmm.png) |
...
| 15. [Создание экранированных виртуальных машин с помощью VMM](/system-center/vmm/guarded-deploy-vm) | ![Шаг 15. Создание экранированных виртуальных машин с помощью VMM](../media/Guarded-Fabric-Shielded-VM/guarded-host-shielded-vms.png) |
