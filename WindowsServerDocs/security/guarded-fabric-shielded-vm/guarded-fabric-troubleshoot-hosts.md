---
description: Дополнительные сведения см. в статье Устранение неполадок защищенных узлов
title: Устранение неполадок защищенных узлов
ms.topic: article
...
Passed                    | Узел передал аттестацию.
TransientError            | Последняя попытка аттестации завершилась сбоем из-за неисправности сети, службы или другой временной ошибки. Повторите последнюю операцию.
