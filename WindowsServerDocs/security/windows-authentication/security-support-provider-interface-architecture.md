...
Поскольку протокол Kerberos был протоколом проверки подлинности по умолчанию, начиная с Windows 2000, все доменные службы поддерживают SSP Kerberos. К этим службам относятся:
...
-   [\[MS-КИЛЕ \] : расширения протокола Kerberos](https://msdn.microsoft.com/library/cc233855(PROT.10).aspx)

-   [\[MS-SFU \] : расширения протокола Kerberos: служба для пользователя и спецификация протокола ограниченного делегирования](https://msdn.microsoft.com/library/cc246071(PROT.13).aspx)
...
### <a name="digest-security-support-provider"></a><a name="BKMK_DigestSSP"></a>Поставщик поддержки дайджест-безопасности
...
-   [\[MS-ДПСП \] : хэш-расширения протокола](https://msdn.microsoft.com/library/cc227906(PROT.13).aspx)
...
-   [\[MS-СПНГ \] : простые и защищенные расширения, поддерживающие механизм согласования API (SPNEGO)](https://msdn.microsoft.com/library/cc247021(PROT.13).aspx)

-   [\[\]Спецификация протокола проверки подлинности HTTP MS-N2HT: Negotiate и Nego2](https://msdn.microsoft.com/library/dd303576(PROT.13).aspx)
...
-   [\[MS-КССП \] : Спецификация протокола службы поддержки безопасности учетных данных (CredSSP)](https://msdn.microsoft.com/library/cc226764(PROT.13).aspx)
