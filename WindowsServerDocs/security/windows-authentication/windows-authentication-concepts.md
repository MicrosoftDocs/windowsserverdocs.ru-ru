...
-   [Учетные записи Active Directory](/windows/security/identity-protection/access-control/active-directory-accounts)

-   [Группы безопасности Active Directory](/windows/security/identity-protection/access-control/active-directory-security-groups)

-   [Локальные учетные записи](https://technet.microsoft.com/itpro/windows/keep-bastion.local-accounts)

-   [Учетные записи Майкрософт](/windows/security/identity-protection/access-control/microsoft-accounts)

-   [Учетные записи службы](/windows/security/identity-protection/access-control/service-accounts)

-   [Специальные группы](/windows/security/identity-protection/access-control/special-identities)
...
Сведения о том, как работает доверие, см. в статье [как работают отношения доверия между доменами и лесами](/previous-versions/windows/it-pro/windows-server-2003/cc773178(v=ws.10)).
...
Дополнительные сведения о смене протокола см. в разделе [Смена протокола Kerberos и ограниченное делегирование](/previous-versions/windows/it-pro/windows-server-2003/cc758097(v=ws.10)).
