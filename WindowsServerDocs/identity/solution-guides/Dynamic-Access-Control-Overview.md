---
description: Дополнительные сведения см. в статье динамический контроль доступа
...
### <a name="central-access-rules"></a><a name="BKMK_Rules"></a>Централизованные правила доступа
...
### <a name="claims"></a><a name="BKMK_Claims"></a>Утверждения
