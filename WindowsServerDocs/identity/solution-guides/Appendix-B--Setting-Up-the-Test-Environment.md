...
7. Нажмите кнопку **ОК** три раза, чтобы завершить операцию и вернуться в центр администрирования Active Directory.
   ...
   ![Руководство по решению.](media/Appendix-B--Setting-Up-the-Test-Environment/PowerShellLogoSmall.gif)***<em>эквивалентные команды Windows PowerShell</em>***
...
1.  На **начальном экране** введите **Администрирование**, а затем на панели **Поиск** щелкните **Параметры**. В результатах **Параметры** щелкните **Администрирование**. Откройте консоль управления групповой политикой в папке **Администрирование**.
