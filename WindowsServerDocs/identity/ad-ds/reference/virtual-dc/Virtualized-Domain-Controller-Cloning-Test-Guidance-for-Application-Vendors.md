---
description: См. Дополнительные сведения о виртуализации клонированных контроллеров домена руководство по тестированию для поставщиков приложений
