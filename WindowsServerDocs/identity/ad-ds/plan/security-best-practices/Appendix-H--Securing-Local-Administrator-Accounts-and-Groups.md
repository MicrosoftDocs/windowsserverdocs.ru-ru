...
5.  В окне **командной строки** введите **net use \\ \\ <Server Name> \C $/User: <Server Name> \ администратор**, где <Server Name> — это имя рядового сервера или рабочей станции, доступ к которой осуществляется по сети.
