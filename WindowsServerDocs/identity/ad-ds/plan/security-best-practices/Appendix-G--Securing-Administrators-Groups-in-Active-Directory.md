---
description: 'Дополнительные сведения о: Приложение G. Защита групп администраторов в Active Directory'
...
2.  Чтобы удалить всех членов из группы "Администраторы", выполните следующие действия.
    ...
    1.  Дважды щелкните группу **администраторов** и перейдите на вкладку **члены** .
        ...
        ![Снимок экрана, на котором показана вкладка "члены" для удаления всех членов из группы "Администраторы".](media/Appendix-G--Securing-Administrators-Groups-in-Active-Directory/SAD_79.gif)
...
2.  В дереве консоли разверните узел &lt; лес &gt; \домаинс \\ &lt; Domain &gt; , а затем **Групповая политика объекты** (где &lt; лес — это &gt; имя леса, а &lt; домен &gt; — имя домена, в котором вы хотите задать групповая политика).

3.  В дереве консоли щелкните правой кнопкой мыши элемент **Групповая политика объекты** и выберите команду **создать**.

    ![Снимок экрана, на котором показано, где можно выбрать новое, чтобы защитить группы администраторов в Active Directory.](media/Appendix-G--Securing-Administrators-Groups-in-Active-Directory/SAD_80.gif)
...
4.  В диалоговом окне **Создание объекта групповой политики** введите <GPO Name> и нажмите кнопку **ОК** (где *имя GPO* — это имя этого объекта групповой политики).
    ...
    ![Снимок экрана, на котором показано, где можно присвоить имя G P O в диалоговом окне Создание объекта групповой политики, чтобы защитить группы администраторов.](media/Appendix-G--Securing-Administrators-Groups-in-Active-Directory/SAD_81.gif)
...
6.  Перейдите к компьютеру \ политики \ **Параметры безопасности Локальные политики** и щелкните **Назначение прав пользователя**.
    ...
    ![Снимок экрана, на котором показано расположение для перемещения. чтобы защитить группы администраторов, можно выбрать параметр Администратор прав пользователя.](media/Appendix-G--Securing-Administrators-Groups-in-Active-Directory/SAD_82.gif)
...
7.  Настройте права пользователя, чтобы запретить членам группы "Администраторы" доступ к рядовым серверам и рабочим станциям по сети, выполнив следующие действия.
    ...
    3.  Введите **Администраторы**, щелкните **Проверить имена** и нажмите кнопку **ОК**.
        ...
        ![Снимок экрана, показывающий, как убедиться, что вы настроили права пользователя, чтобы запретить членам группы «Администраторы» доступ к серверам и рабочим станциям по сети.](media/Appendix-G--Securing-Administrators-Groups-in-Active-Directory/SAD_83.gif)
...
8.  Настройте права пользователя, чтобы запретить членам группы "Администраторы" входить в систему в качестве пакетного задания, выполнив следующие действия.
    ...
    3.  Введите **Администраторы**, щелкните **Проверить имена** и нажмите кнопку **ОК**.
        ...
        ![Снимок экрана, показывающий, как проверить, настроены ли права пользователя для запрета входа членов группы "Администраторы" в качестве пакетного задания.](media/Appendix-G--Securing-Administrators-Groups-in-Active-Directory/SAD_84.gif)
...
9. Настройте права пользователя, чтобы запретить членам группы "Администраторы" входить в систему как службу, выполнив следующие действия.
    ...
    3.  Введите **Администраторы**, щелкните **Проверить имена** и нажмите кнопку **ОК**.
        ...
        ![Снимок экрана, показывающий, как проверить, настроены ли права пользователя для запрета входа членов группы "Администраторы" в качестве службы.](media/Appendix-G--Securing-Administrators-Groups-in-Active-Directory/SAD_85.gif)
...
11. В **Групповая политика управления** свяжите объект групповой политики с подразделениями рядового сервера и рабочей станции, выполнив следующие действия.
    ...
    1.  Перейдите к &lt; лесу &gt;> домен \домаинс \\ &lt; &gt; (где &lt; лес — это &gt; имя леса, а &lt; домен &gt; — имя домена, в котором нужно задать групповая политика).
    ...
    2.  Щелкните правой кнопкой мыши подразделение, к которому будет применен объект GPO, и выберите команду **связать существующий объект GPO**.
        ...
        ![Снимок экрана, на котором показана связь с существующим параметром меню G P O при щелчке правой кнопкой мыши подразделения.](media/Appendix-G--Securing-Administrators-Groups-in-Active-Directory/SAD_86.gif)

    3.  Выберите только что созданный объект групповой политики и нажмите кнопку **ОК**.

        ![Снимок экрана, на котором показано, где выбрать только что созданный объект групповой политики.](media/Appendix-G--Securing-Administrators-Groups-in-Active-Directory/SAD_87.gif)
    ...
    5.  Создайте ссылки на все подразделения, содержащие рядовые серверы.
        ...
        ![Снимок экрана, на котором показаны параметры конфигурации, блокирующие неправильное использование встроенных локальных учетных записей и администраторов домена.](media/Appendix-G--Securing-Administrators-Groups-in-Active-Directory/SAD_88.gif)
...
2.  В дереве консоли разверните узел <Forest> \домаинс \\ <Domain> , а затем **Групповая политика объекты** (где <Forest> — имя леса, а <Domain> — имя домена, в котором нужно задать групповая политика).

3.  В дереве консоли щелкните правой кнопкой мыши элемент **Групповая политика объекты** и выберите команду **создать**.

    ![Снимок экрана, на котором показано меню, отображаемое при щелчке правой кнопкой мыши групповая политика объекты.](media/Appendix-G--Securing-Administrators-Groups-in-Active-Directory/SAD_89.gif)
...
4.  В диалоговом окне **Создание объекта групповой политики** введите <GPO Name> и нажмите кнопку **ОК** (где <GPO Name> — это имя этого объекта групповой политики).
    ...
    ![Снимок экрана, на котором показано, где присвоить имя G P O, чтобы можно было защитить группы администраторов.](media/Appendix-G--Securing-Administrators-Groups-in-Active-Directory/SAD_90.gif)

5.  В области сведений щелкните правой кнопкой мыши **<GPO Name>** и выберите команду **изменить**.

6.  Перейдите к компьютеру \ политики \ **Параметры безопасности Локальные политики** и щелкните **Назначение прав пользователя**.

    ![Снимок экрана, на котором показано, где можно перемещаться, чтобы выбрать администратора прав пользователя для защиты групп администраторов.](media/Appendix-G--Securing-Administrators-Groups-in-Active-Directory/SAD_91.gif)
...
7.  Настройте права пользователя, чтобы разрешить членам группы "Администраторы" доступ к контроллерам домена по сети, выполнив следующие действия.
    ...
    3.  Нажмите кнопку **Добавить пользователя или группу** и нажмите кнопку **Обзор**.
        ...
        ![Снимок экрана, показывающий, как проверить, настроены ли права пользователя на разрешение доступа к контроллерам домена по сети для членов группы "Администраторы".](media/Appendix-G--Securing-Administrators-Groups-in-Active-Directory/SAD_92.gif)
...
8.  Настройте права пользователя, чтобы разрешить членам группы "Администраторы" выполнять локальный вход, выполнив следующие действия.
    ...
    3.  Введите **Администраторы**, щелкните проверить **имена** и нажмите кнопку **ОК**.
        ...
        ![Снимок экрана, показывающий, как проверить, настроены ли права пользователя на разрешение локального входа членам группы "Администраторы".](media/Appendix-G--Securing-Administrators-Groups-in-Active-Directory/SAD_93.gif)
...
9. Настройте права пользователя, чтобы разрешить членам группы "Администраторы" выполнять вход через службы удаленных рабочих столов, выполнив следующие действия.
    ...
    3.  Введите **Администраторы**, щелкните **Проверить имена** и нажмите кнопку **ОК**.
        ...
        ![Снимок экрана, показывающий, как убедиться, что вы настроили права пользователя, чтобы разрешить членам группы "Администраторы" входить в систему с помощью службы удаленных рабочих столов.](media/Appendix-G--Securing-Administrators-Groups-in-Active-Directory/SAD_94.gif)
...
11. В **Групповая политика управления** свяжите объект групповой политики с подразделением контроллеров домена, выполнив следующие действия.
    ...
    2.  Щелкните правой кнопкой мыши подразделение контроллеров домена и выберите команду **связать существующий объект GPO**.
        ...
        ![Снимок экрана, на котором показана ссылка на существующий пункт меню GPO при попытке связать G P O с подразделением контроллеров домена.](media/Appendix-G--Securing-Administrators-Groups-in-Active-Directory/SAD_95.gif)

    3.  Выберите только что созданный объект групповой политики и нажмите кнопку **ОК**.

        ![Снимок экрана, на котором показано, где выбрать объект групповой политики, который вы только что создали при связывании G P O с рабочими станциями и сервером.](media/Appendix-G--Securing-Administrators-Groups-in-Active-Directory/SAD_96.gif)
...
4.  При появлении запроса на подтверждение повышения прав нажмите кнопку **Да**.
    ...
    ![Снимок экрана, посвященный диалоговому окну "контроль учетных записей пользователей".](media/Appendix-G--Securing-Administrators-Groups-in-Active-Directory/SAD_97.gif)
...
6.  На следующем снимке экрана показано сообщение об ошибке, которое должно появиться.
    ...
    ![Снимок экрана, на котором выделено сообщение об ошибке при входе.](media/Appendix-G--Securing-Administrators-Groups-in-Active-Directory/SAD_98.gif)
...
16. Появится диалоговое окно, похожее на следующее.
    ...
    ![Снимок экрана, на котором выделено диалоговое окно планировщик задач.](media/Appendix-G--Securing-Administrators-Groups-in-Active-Directory/SAD_99.gif)
