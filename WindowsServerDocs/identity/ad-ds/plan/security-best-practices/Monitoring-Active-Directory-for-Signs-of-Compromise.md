---
description: Дополнительные сведения см. в статье мониторинг Active Directory для подписывания компромисса
...
##### <a name="mpssvc-rule-level-policy-change"></a>Изменение политики Rule-Level MPSSVC
