---
description: 'Дополнительные сведения: сопоставление требований к проектированию с моделями проектирования лесов'
...
|[Сценарий 2. использование леса организации или домена для автономной работы служб](#BKMK_2)|Нет|Нет|Недоступно|Нет|Да|
|[Сценарий 3. использование леса организации или леса ресурсов для изоляции служб](#BKMK_3)|Нет|Нет|Недоступно|Да|Н/Д|
|[Сценарий 4. использование леса организации или ограниченного доступа для изоляции данных](#BKMK_4)|Недоступно|Да|Н/Д|Недоступно|Недоступно|
|[Сценарий 5. Используйте организационный лес или перенастройте брандмауэр для ограниченного подключения.](#BKMK_5)|Да|Нет|Недоступно|Нет|Нет|
|[Сценарий 6. использование леса или домена организации и перенастройка брандмауэра для автономной работы службы с ограниченным подключением](#BKMK_6)|Да|Нет|Недоступно|Нет|Да|
|[Сценарий 7. использование леса ресурсов и перенастройка брандмауэра для изоляции служб с ограниченным подключением](#BKMK_7)|Да|Нет|Недоступно|Да|Н/Д|
