...
> [!NOTE]
> При сбросе пароля учетной записи службы центр распространения ключей дважды требуется 10-часовой период ожидания между перезагрузками.
