...
6. На экране **компоненты** выберите **Cистема архивации данных Windows Server** и щелкните **Далее** 
    ![ снимок экрана, в котором выделяется выбранный параметр Cистема архивации данных Windows Server.](media/AD-Forest-Recovery-Backing-up-a-Full-Server/fullbackup2.png)
...
1. Откройте **Диспетчер сервера**, выберите **Сервис**, а затем щелкните **Cистема архивации данных Windows Server**.
   ...
   ![Снимок экрана, на котором показано, где следует указывать на средства администрирования, а затем выберите cистема архивации данных Windows Server.](media/AD-Forest-Recovery-Backing-up-a-Full-Server/fullbackup1.png)
...
5. В мастере однократной архивации на странице **Параметры резервного копирования** выберите **другие параметры**, а затем нажмите кнопку **Далее**.
   ...
   ![Снимок экрана, на котором показаны различные параметры выбранного параметра.](media/AD-Forest-Recovery-Backing-up-a-Full-Server/fullbackup3.png)
...
9. На экране подтверждения нажмите кнопку **резервное копирование**.
   ...
   ![Снимок экрана, на котором показан экран хода выполнения резервного копирования.](media/AD-Forest-Recovery-Backing-up-a-Full-Server/fullbackup4.png)
