...
title: Руководство по настройке защищенных учетных записей
...
-   [Политики аутентификации](../../ad-ds/manage/How-to-Configure-Protected-Accounts.md#BKMK_CreateAuthNPolicies)
...
-   [Ограниченный административный режим для подключения к удаленному рабочему столу](/archive/blogs/kfalde/restricted-admin-mode-for-rdp-in-windows-8-1-2012-r2)
...
### <a name="requirements-for-using-protected-accounts"></a><a name="BKMK_Prereq"></a>Требования для использования защищенных учетных записей
...
### <a name="troubleshoot-events-related-to-protected-users"></a><a name="BKMK_TrubleshootingEvents"></a>Диагностика неполадок событий, связанных с группой защищенных пользователей
...
### <a name="provide-dc-side-protections-for-services-and-computers"></a><a name="BKMK_ProvidePUdcProtections"></a>Защита служб и компьютеров со стороны контроллера домена
...
-   Отклонение проверки подлинности NTLM: Настраивается только с помощью [политик блокировки NTLM](/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/jj865674(v=ws.10)).
...
-   Отклонение при использовании RC4 в предварительной проверке подлинности Kerberos: нельзя настроить.
    ...
    > [!NOTE]
    > Хотя можно [изменить конфигурацию поддерживаемых способов шифрования](/archive/blogs/openspecification/windows-configurations-for-kerberos-supported-encryption-type), не рекомендуется менять эти настройки для учетных записей компьютеров без предварительного тестирования в целевой среде.
...
### <a name="requirements-for-using-authentication-policies"></a><a name="BKMK_ReqForAuthnPolicies"></a>Требования для использования политик проверки подлинности
