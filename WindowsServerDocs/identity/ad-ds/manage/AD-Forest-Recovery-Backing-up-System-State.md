---
description: Дополнительные сведения о восстановлении леса AD. Резервное копирование данных состояния системы
...
1. Откройте **Диспетчер сервера**, выберите **Сервис**, а затем щелкните **Cистема архивации данных Windows Server**.
   ...
   ![Снимок экрана, посвященный пункту меню "cистема архивации данных Windows Server".](media/AD-Forest-Recovery-Backing-up-a-Full-Server/fullbackup1.png)
...
5. В мастере однократной архивации на странице **Параметры резервного копирования** выберите **другие параметры**, а затем нажмите кнопку **Далее**.
   ...
   ![Снимок экрана, на котором показана страница "Параметры резервного копирования" с выбранными параметрами "другие параметры".](media/AD-Forest-Recovery-Backing-up-a-Full-Server/fullbackup3.png)
...
7. На экране **Выбор элементов для архивации** нажмите кнопку **Добавить элементы** и выберите **состояние системы** и нажмите кнопку **ОК**.
   ...
   ![Снимок экрана, на котором установлен флажок состояние системы. ](media/AD-Forest-Recovery-Backing-up-System-State/systemstatebackup.png)
