---
description: Дополнительные сведения см. в статье Устранение неполадок, связанных с репликацией Active Directory
...
Для средства на основе пользовательского интерфейса, помогающего отслеживать репликацию и диагностировать ошибки, скачайте и запустите [средство помощника по служба поддержки Майкрософт и средству восстановления](https://aka.ms/sara-adreplication) **или** воспользуйтесь [средством состояние репликации Active Directory](https://www.microsoft.com/download/details.aspx?id=30005) , если требуется проанализировать состояние репликации.
