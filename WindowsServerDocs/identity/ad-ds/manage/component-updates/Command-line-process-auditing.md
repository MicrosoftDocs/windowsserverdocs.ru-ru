...
![Снимок экрана, на котором выделена Командная строка процесса.](media/Command-line-process-auditing/GTR_ADDS_Event4688.gif)
...
![Снимок экрана, показывающий ](media/Command-line-process-auditing/GTR_ADDS_IncludeCLISetting.gif)
...
![Снимок экрана, на котором показана Командная строка include в диалоговом окне события создания процесса.](media/Command-line-process-auditing/GTR_ADDS_Event4719.gif)
