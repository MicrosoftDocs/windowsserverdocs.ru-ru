---
description: 'Дополнительные сведения: обновления компонентов служб каталогов'
...
Чтобы повысить или уменьшить режим работы домена с помощью Windows PowerShell, используйте командлет Set-ADDomainMode.
...
[Создание более эффективных приложений Microsoft Active Directory-Enabled](/previous-versions/ms808539(v=msdn.10))
