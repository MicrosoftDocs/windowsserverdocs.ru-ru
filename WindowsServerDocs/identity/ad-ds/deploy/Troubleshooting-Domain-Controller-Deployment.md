---
description: Дополнительные сведения см. в статье Устранение неполадок при развертывании контроллера домена
...
![Схема, на которой показан рабочий процесс для устранения неполадок при развертывании контроллера домена.](media/Troubleshooting-Domain-Controller-Deployment/adds_deploy_troubleshooting.png)
...
| Код ошибки | Объяснение | Предлагаемое решение |
|--|--|--|
...
| Решение и примечания | Не указывайте параметры, которые уже определены в предварительно созданной учетной записи контроллера домена только для чтения. К ним относятся следующие.<p>Код — реадонлиреплика<br />-инсталлднс<br />-донотконфигуреглобалкаталог<br />-sitename<br />-инсталлднс |
