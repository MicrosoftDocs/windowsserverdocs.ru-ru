...
| Код ошибки | Описание | Предлагаемое решение |
|--|--|--|
...
| Решение и примечания | Не указывайте параметры, которые уже определены в предварительно созданной учетной записи контроллера домена только для чтения. К ним относятся:<p>Код — реадонлиреплика<br />-инсталлднс<br />-донотконфигуреглобалкаталог<br />-sitename<br />-инсталлднс |
