---
description: 'Дополнительные сведения: понижение роли контроллеров домена и доменов'
...
|--|--|
| Uninstall-ADDSDomainController | -SkipPreChecks<p>*-LocalAdministratorPassword*<p>-Confirm<p>***-Credential**_<p> -демотеоператионмастерроле <p>_-днсделегатионремовалкредентиал *<p> -Force <p>*-форцеремовал *<p>* -игнореластдЦиндомаинмисматч *<p>* -IgnoreLastDNSServerForZone *<p>* -LastDomainControllerInDomain *<p> -Norebootoncompletion <p>*-RemoveApplicationPartitions *<p>* -RemoveDNSDelegation *<p>-RetainDCMetadata |
| Uninstall-WindowsFeature/Remove-WindowsFeature | ***-Имя** _<p>_ *_-IncludeManagementTools_* _<p>_ Перезагрузить<p>-Remove<p>-Force<p>-ComputerName<p>-Credential<p>-LogPath<p>-Vhd |
...
![Пример Uninstall-ADDSDomainController PowerShell](media/Demoting-Domain-Controllers-and-Domains--Level-200-/ADDS_PSUninstallConfirm.png)

![Пример Uninstall-WindowsFeature PowerShell](media/Demoting-Domain-Controllers-and-Domains--Level-200-/ADDS_PSUninstallWindowsFeature.png)
...
![Пример использования Uninstall-ADDSDomainController PowerShell](media/Demoting-Domain-Controllers-and-Domains--Level-200-/ADDS_PSUninstallFinished.png)
...
![Пример Uninstall-ADDSDomainController PowerShell для Ластдомаинконтроллериндомаин](media/Demoting-Domain-Controllers-and-Domains--Level-200-/ADDS_PSUninstallExampleLastDC.png)
