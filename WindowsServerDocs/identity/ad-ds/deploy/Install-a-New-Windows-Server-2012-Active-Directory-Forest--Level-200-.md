---
description: 'Дополнительные сведения: Установка нового леса Active Directory Windows Server 2012 (уровень 200)'
...
|--|--|
| Install-WindowsFeature/Add-WindowsFeature | ***-Имя** _<p>_ -Restart *<p>* -инклудеаллсубфеатуре *<p>* -IncludeManagementTools *<p> - <p> Source*-ComputerName *<p> -Credential <p> - <p> logPath*-VHD *<p>* -конфигуратионфилепас * |
...
### <a name="create-an-ad-ds-forest-root-domain-with-windows-powershell"></a><a name="BKMK_PS"></a>Создание корневого домена леса доменных служб Active Directory с помощью Windows PowerShell
...
|--|--|
| install-addsforest | -Confirm<p>*-Креатеднсделегатион*<p>*-DatabasePath*<p>*-DomainMode*<p>***-Имя_домена** _<p>_ *_-Домаиннетбиоснаме_* _<p>_ -Днсделегатионкредентиал *<p>* -леса *<p> -Force <p>*-инсталлднс *<p>* -logPath *<p> -ноднсоннетворк <p> -норебутонкомплетион <p>*-сафемодеадминистраторпассворд *<p> -SkipAutoConfigureDNS <p> -SkipPreChecks <p>*-SYSVOLPath *<p>* -WhatIf * |
...
[Службы домен Active Directory (портал TechNet)](/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc770946(v=ws.10)) 
 ...
 [Техническое руководство по Windows Server (Windows server 2003)](/previous-versions/windows/it-pro/windows-server-2003/cc739127(v=ws.10)) 
 ...
 [Active Directory администрирования с помощью Windows PowerShell (Windows Server 2008 R2)](/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/dd378937(v=ws.10)) 
 [Обратитесь к группе по службам каталогов (официальный блог по технической поддержке корпорации Майкрософт)](/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/dd378937(v=ws.10))
