...
![Схема, на которой показаны домен Active Directory службы Read-Only промежуточный процесс контроллера домена, описанный выше.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/adds_stagedcreation.png)

## <a name="stage-rodc-windows-powershell"></a><a name=BKMK_StagePS></a>Поэтапная установка RODC с помощью Windows PowerShell
...
|--|--|
| Add-addsreadonlydomaincontrolleraccount | -SkipPreChecks<p>***-Домаинконтроллераккаунтнаме * *_<p>_* _-имя_домена_ *_<p>_* _-SiteName_*_<p>_ -алловпассвордрепликатионаккаунтнаме* <p>***-Credentials **_<p>_ -делегатедадминистратораккаунтнаме*<p>*-DenyPasswordReplicationAccountName*<p>*-Ноглобалкаталог*<p>*-Инсталлднс*<p>-ReplicationSourceDC |
...
![Схема, на которой показан процесс настройки служб домен Active Directory Services, описанный выше.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/adds_stageddeploy_beta1.png)

## <a name="attach-rodc-windows-powershell"></a><a name=BKMK_AttachPS></a>Подключение RODC с помощью Windows PowerShell

| Командлет ADDSDeployment | Аргументы (**жирные** аргументы являются обязательными). Аргументы, выделенные *курсивом*, можно указать с помощью Windows PowerShell или мастера настройки доменных служб Active Directory). |
|--|--|
| Install-AddsDomaincontroller | -SkipPreChecks<p>***-Имя_домена **_<p>_ -сафемодеадминистраторпассворд* <p> *-аппликатионпартитионсторепликате* <p> *-креатеднсделегатион* <p>***-Credential **_<p> -CriticalReplicationOnly <p>_-DatabasePath *<p>* -DNSDelegationCredential *<p>* -InstallationMediaPath *<p>* -logPath *<p> -Norebootoncompletion <p>*-ReplicationSourceDC *<p>* -SystemKey- *<p>* SYSVOLPath * <p> **** *-UseExistingAccount _ |

> [!NOTE]
> Аргумент _ *-Credential** требуется только в том случае, если вы еще не вошли в систему как член группы "Администраторы домена".

## <a name="staging"></a>Промежуточный
![Снимок экрана центр администрирования Active Directory, на котором показан параметр "предварительно создать учетную запись контроллера домена только для чтения", выделенный в область задач.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_PreCreateRODC.png)
...
![Снимок экрана: страница приветствия мастера установки доменных служб Azure Directory с выбранным параметром "использовать расширенный режим установки".](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_WelcomeStage1.png)
...
![Снимок экрана: страница "Сетевые учетные данные" мастера установки доменных служб Azure Directory.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_Stage1Creds.png)
...
![Снимок экрана с предупреждением мастера установки доменных служб Azure Directory, в котором говорится, что средство Adprep/родкпреп еще не запущено.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_RODCPrepNotRunError.png)

### <a name="specify-the-computer-name"></a>Задайте имя компьютера
![Снимок экрана: страница "укажите имя компьютера" мастера установки доменных служб Azure Directory.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_Stage1CompName.png)
...
![Снимок экрана: страница "Выбор сайта" мастера установки доменных служб Azure Directory.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_Stage1Site.png)
...
![Снимок экрана: страница "укажите параметры контроллера домена" мастера установки доменных служб Azure Directory.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_Stage1DCOptions.png)
...
![Снимок экрана: страница "укажите политику репликации паролей" мастера установки доменных служб Azure Directory.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_Stage1PRP.png)
...
![Снимок экрана: диалоговое окно "Добавление групп, пользователей и компьютеров".](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_Stage1PRPAllow.png)

### <a name="delegation-of-rodc-installation-and-administration"></a>Делегирование установки и администрирования RODC
![Снимок экрана: страница "Делегирование установки и администрирования RODC" мастера установки доменных служб Azure Directory.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_Stage1DelegateAdmin.png)
...
![Снимок экрана со страницей "Сводка" мастера установки доменных служб Azure Directory.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_Stage1Summary.png)
...
![Снимок экрана со страницей "ход выполнения" мастера установки доменных служб Azure Directory.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_Stage1InstallProgress.png)
...
![Снимок экрана с последней страницей мастера установки доменных служб Azure Directory.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_Stage1Complete.png)
...
Поскольку **Add-аддсреадонлидомаинконтроллераккаунт** содержит только одно действие с двумя этапами (проверка готовности и установка), на следующих снимках экрана показан этап установки с минимальными необходимыми аргументами.

![Снимок экрана: Окно PowerShell с полным командлетом Add-аддсреадонлидомаинконтроллераккаунт.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_PSAddRODC.png)

![Снимок экрана окна PowerShell, отображающего результат командлета Add-аддсреадонлидомаинконтроллераккаунт.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_PSAddRODCValidating.png)
...
![Снимок экрана: выделенная учетная запись незанятого контроллера домена центр администрирования Active Directory.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_Unoccupied.png)
...
![Снимок экрана страницы "Конфигурация развертывания" мастера настройки служб домен Active Directory Services.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_RODCDeployConfig.png)
...
![Снимок экрана со страницей параметров контроллера домена в мастере настройки служб домен Active Directory Services.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_Stage2DCOptions.png)
...
![Снимок экрана со страницей "Дополнительные параметры" мастера настройки служб домен Active Directory Services.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_Stage2AdditionalOptions.png)
...
![Снимок экрана: окно командной строки, в котором отображаются результаты запуска программы Ntdsutil.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_StagedIFM.png)
...
### <a name="paths"></a>Пути
![Снимок экрана со страницей "пути" мастера настройки служб домен Active Directory Services.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_Stage2Paths.png)
...
![Снимок экрана со страницей параметров проверки в мастере настройки служб домен Active Directory Services.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_Stage2ReviewOptions.png)
...
![Снимок экрана окна PowerShell, отображающего результаты командлета Install-ADDSDomainController.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_Stage2WhatIf.png)

### <a name="prerequisites-check"></a>Проверка готовности к установке
![Снимок экрана: страница "Проверка предварительных требований" мастера настройки служб домен Active Directory Services.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_Stage2PrereqCheck.png)
...
![Снимок экрана со страницей установки мастера настройки служб домен Active Directory Services.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_Stage2Installation.png)
...
![Снимок экрана окна PowerShell, отображающего результат командлета Install-аддсдомаинконтроллер.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_PSStage2.png)

![Снимок экрана окна PowerShell, показывающего ход выполнения проверки и установки.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_PSStage2Complete.png)
...
![Снимок экрана со страницей "результаты" мастера настройки служб домен Active Directory Services.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_ForestSignOff.png)
...
![На схеме, показывающей процесс контроллера домена домен Active Directory Services Read-Only, как описано выше, без промежуточного рабочего процесса.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/adds_rodcdeploy.png)
...
| Командлет ADDSDeployment | Аргументы (**жирные** аргументы являются обязательными). Аргументы, выделенные *курсивом*, можно указать с помощью Windows PowerShell или мастера настройки доменных служб Active Directory). |
|--|--|
| Install-AddsDomainController | -SkipPreChecks<p>***- <p> Имя_домена **_<p>_ -сафемодеадминистраторпассворд****-sitename **_<p>_ -аппликатионпартитионсторепликате *<p>* -креатеднсделегатион * <p> * * *-Credential** _<p>_ -CriticalReplicationOnly *<p>* -DatabasePath *<p>* -DNSDelegationCredential *<p> -DNSOnNetwork <p>*-InstallationMediaPath *<p>* -InstallDNS *<p>* -*<p> <p>**<p> <p>**<p> <p>* *<p>* *<p>* *<p>* *<p>* logPath-MoveInfrastructureOperationMasterRoleIfNecessary-NoGlobalCatalog-Norebootoncompletion-ReplicationSourceDC-SkipAutoConfigureDNS-SystemKey<p>***-Реадонлиреплика** _ |
...
### <a name="deployment-configuration"></a>Конфигурация развертывания
![Снимок экрана страницы "Конфигурация развертывания" мастера настройки служб домен Active Directory Services при отсутствии промежуточного развертывания.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_RODCDeployConfig.png)
...
### <a name="domain-controller-options"></a>Параметры контроллера домена
![Снимок экрана со страницей параметров контроллера домена в мастере настройки служб домен Active Directory Services при отсутствии промежуточного развертывания.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_RODCDCOptions.png)
...
![Снимок экрана со страницей параметров RODC мастера настройки служб домен Active Directory Services при отсутствии промежуточного развертывания.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_RODCOptions.png)
...
![Снимок экрана: диалоговое окно "Выбор пользователя, компьютера, учетной записи службы".](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_SelectDelAdmin.png)

### <a name="additional-options"></a>Дополнительные параметры
![Снимок экрана со страницей дополнительных параметров мастера настройки служб домен Active Directory Services при отсутствии промежуточного развертывания.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_RODCAdditionalOptions.png)
...
![Снимок экрана: окно командной строки, в котором отображаются результаты запуска программы Ntdsutil, если промежуточное развертывание отсутствует.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_PSIFM.png)
...
### <a name="paths"></a>Пути
![Снимок экрана со страницей "пути" мастера настройки служб домен Active Directory Services при отсутствии промежуточного развертывания.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_RODCPaths.png)
...
![Снимок экрана со страницей параметров подготовки мастера настройки служб домен Active Directory Services при отсутствии промежуточного развертывания.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_RODCPrepOptions.png)
...
### <a name="review-options-and-view-script"></a>"Просмотреть параметры" и "Просмотреть скрипт"
![Снимок экрана со страницей параметров проверки в мастере настройки служб домен Active Directory Services при отсутствии промежуточного развертывания.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_RODCReviewOptions.png)
...
![Снимок экрана окна PowerShell, отображающего результаты командлета Install-ADDSDomainController, если промежуточное развертывание отсутствует.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_RODCWhatIf.png)

### <a name="prerequisites-check"></a>Проверка готовности к установке
![Снимок экрана с страницей проверки готовности мастера настройки служб домен Active Directory Services при отсутствии промежуточного развертывания.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_RODCPrereqCheck.png)
...
### <a name="installation"></a>Установка
![Снимок экрана страницы установки мастера настройки служб домен Active Directory Services при отсутствии промежуточного развертывания.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_RODCInstallation.png)
...
Обязательные и необязательные аргументы см. в таблице **командлетов аддсдеплоймент** в начале этого раздела.

Выполнение командлета **Install-addsdomaincontroller** включает только два этапа (проверка предварительных требований и установка). На двух иллюстрациях ниже показан этап установки с минимальным необходимым набором аргументов: **-domainname**, **-readonlyreplica**, **-sitename** и **-credential**. Обратите внимание на то, что командлет **Install-ADDSDomainController**, как и диспетчер сервера, напоминает об автоматической перезагрузке сервера после повышения роли:

![Снимок экрана окна PowerShell, отображающего результат командлета Install-аддсдомаинконтроллер при отсутствии промежуточного развертывания.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_PSInstallRODC.png)

![Снимок экрана окна PowerShell, показывающего ход выполнения проверки и установки при отсутствии промежуточного развертывания.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_PSInstallRODCProgress.png)
...
### <a name="results"></a>Результаты
![Снимок экрана со страницей "результаты" мастера настройки служб домен Active Directory Services при отсутствии промежуточного развертывания.](media/Install-a-Windows-Server-2012-Active-Directory-Read-Only-Domain-Controller--RODC---Level-200-/ADDS_SMI_TR_RODCSignoff.png)
