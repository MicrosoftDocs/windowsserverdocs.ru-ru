...
17. Нажмите кнопку **Обзор** и найдите путь к общей папке, которую необходимо использовать в диалоговом окне путь к общей папке. Щелкните **Далее**.
