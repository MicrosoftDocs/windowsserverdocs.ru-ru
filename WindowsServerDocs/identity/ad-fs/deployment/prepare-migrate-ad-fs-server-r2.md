...
## <a name="next-steps"></a>Next Steps
 [Миграция служб ролей службы федерации Active Directory (AD FS) на Windows server 2012 R2](migrate-ad-fs-service-role-to-windows-server-r2.md) [Миграция сервера федерации AD FS](migrate-ad-fs-fed-server-r2.md) [Миграция AD FS прокси-сервер федерации](migrate-fed-server-proxy-r2.md) , [проверяющий миграцию AD FS на Windows Server 2012 R2](verify-ad-fs-migration.md)
