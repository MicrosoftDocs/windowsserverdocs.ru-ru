---
description: 'Дополнительные сведения о: контрольный список: настройка AD FS для отправки утверждений в AD FS 1. x служба федерации'
