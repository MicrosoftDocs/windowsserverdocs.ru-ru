...
description: Рекомендации по безопасному планированию и развертыванию службы федерации Active Directory (AD FS) (AD FS) и прокси веб-приложения.
author: billmath
ms.author: billmath
manager: femila
ms.date: 05/31/2017
...
![Схема, изображающая стандартную топологию D F S.](media/Best-Practices-Securing-AD-FS/adfssec1.png)
...
![Схема, показывающая необходимые порты и протоколы для развертывания D F S.](media/Best-Practices-Securing-AD-FS/adfssec2.png)
...
Дополнительные сведения о необходимых портах и протоколах, необходимых для гибридных развертываний, [см. в этом документе](/azure/active-directory/hybrid/reference-connect-ports).
...
|/ADFS/Ls/FederationMetadata/2007-06/federationmetadata.xml    |Требование для всех пассивных потоков; и используются в Office 365 или Azure AD для проверки сертификатов AD FS. |
...
5. Перезапустите службу AD FS путем запуска `net stop adfssrv`, а затем `net start adfssrv`.
Руководство по этой возможности можно найти [здесь](/previous-versions/azure/azure-services/dn528859(v=azure.100)).
...
Сведения об установке Azure AD Connect Health для AD FS можно найти [здесь](/azure/active-directory/hybrid/how-to-connect-health-agent-install).
...
Поддерживаемые внешние поставщики MFA включают перечисленные на [этой](/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/dn758113(v=ws.11)) странице, а также HDi глобальные.
