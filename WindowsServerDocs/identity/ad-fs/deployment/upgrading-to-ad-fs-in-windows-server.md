...
![Снимок экрана, показывающий, как присоединить новый сервер Windows Server 2019 к существующей ферме AD FS.](media/Upgrading-to-AD-FS-in-Windows-Server-2016/ADFS_Mixed_1.png)
...
![Снимок экрана, на котором показано окно D F S.](media/Upgrading-to-AD-FS-in-Windows-Server-2016/ADFS_Mixed_3.png)
...
![Снимок экрана окна терминала, в котором показано, как использовать командлет Set-AdfsSyncProperties-Role Примарикомпутер.](media/Upgrading-to-AD-FS-in-Windows-Server-2016/ADFS_Mixed_4.png)
...
![Снимок экрана окна терминала, в котором показано, как использовать командлет Set-AdfsSyncProperties-Role Секондарикомпутер-Примарикомпутернаме {FQDN}.](media/Upgrading-to-AD-FS-in-Windows-Server-2016/ADFS_Mixed_5.png)
...
![Снимок экрана, на котором показано открытие окна управления AD FS сервера федерации Windows Server 2016.](media/Upgrading-to-AD-FS-in-Windows-Server-2016/ADFS_Mixed_6.png)
...
![Снимок экрана, на котором показано, как переходить к каталогу суппорт\адпреп.](media/Upgrading-to-AD-FS-in-Windows-Server-2016/ADFS_Mixed_7.png)
...
![Снимок экрана, показывающий, как выполнить команду adprep/домаинпреп.](media/Upgrading-to-AD-FS-in-Windows-Server-2016/ADFS_Mixed_8.png)
...
![Снимок экрана окна терминала, в котором показано, как выполнить командлет Invoke-AdfsFarmBehaviorLevelRaise.](media/Upgrading-to-AD-FS-in-Windows-Server-2016/ADFS_Mixed_9.png)

9. При появлении запроса введите Y. Это начнет повышать уровень. После завершения этого процесса вы успешно вызвали ФБЛ.

![Снимок экрана окна терминала, в котором показано, когда нужно ввести Y.](media/Upgrading-to-AD-FS-in-Windows-Server-2016/ADFS_Mixed_10.png)
...
![Снимок экрана, на котором показаны новые добавленные возможности.](media/Upgrading-to-AD-FS-in-Windows-Server-2016/ADFS_Mixed_12.png)
