---
title: Перенос сервера федерации AD FS 2,0 на Windows Server 2012 R2
description: Узнайте, как экспортировать и архивировать данные конфигурации AD FS, создать ферму сервера федерации Windows Server 2012 R2 и импортировать исходные данные конфигурации в ферму AD FS Windows Server 2012 R2.
author: billmath
ms.author: billmath
manager: femila
ms.date: 07/10/2017
...
1. Настройте все пользовательские параметры конечных точек служб федерации Active Directory. В консоли управления AD FS выберите элемент **Конечные точки**. Проверьте задействованные конечные точки AD FS по списку задействованных конечных точек AD FS, который был экспортирован в файл в процессе подготовки к переносу AD FS.
...
2. Установите и настройте все сохраненные пользовательские хранилища атрибутов. От имени учетной записи администратора обновите все двоичные файлы пользовательских хранилищ атрибутов до версии платформы .NET Framework 4.0 или более поздней версии прежде, чем ссылаться на них в настройках AD FS.

3. Настройте свойства служб, которые соответствуют параметрам в файле web.config прежних версий.
...
## <a name="next-steps"></a>Next Steps
 [Миграция служб ролей службы федерации Active Directory (AD FS) в Windows Server 2012 R2](migrate-ad-fs-service-role-to-windows-server-r2.md) [Подготовка к переносу сервера федерации AD FS](prepare-migrate-ad-fs-server-r2.md) [Миграция AD FS прокси-сервер федерации](migrate-fed-server-proxy-r2.md) , [проверяющий миграцию AD FS на Windows Server 2012 R2](verify-ad-fs-migration.md)
