---
description: Дополнительные сведения о том, когда использовать правило утверждений преобразования.
...
|Properties (Свойства)|Как описано в предыдущем разделе, контейнер свойств утверждения не сохраняется в токене, поэтому назначения свойств должны выполняться, только если последующие локальные политики будут ссылаться на данные, хранящиеся в свойстве.|
