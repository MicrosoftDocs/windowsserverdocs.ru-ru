---
description: 'Дополнительные сведения о: роль базы данных конфигурации AD FS'
...
![На рисунке показан новый сервер федерации, который регулярно извлекает обновления с основного сервера федерации.](media/adfs2_WID.png)
