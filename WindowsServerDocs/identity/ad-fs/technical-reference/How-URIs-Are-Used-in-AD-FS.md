...
|http: \/ \/ contoso.com \/ HR\/|http: \/ \/ contoso.com \/ роли Runbook \/ Main|Ложь.|Участок пути 1 идентификатора URI1 не соответствует участку пути 1 идентификатора URI2.|
|http: \/ \/ contoso.com \/ HR|http: \/ \/ contoso.com|Ложь.|URI1 имеет больше участков пути, чем URI2.|
|http: \/ \/ contoso.com \/ HR|http: \/ \/ contoso.com \/ HRweb|Ложь.|Первые участки пути не совпадают.|
|HTTPS: \/ \/ contoso.com|http: \/ \/ contoso.com|Ложь.|Части схемы не совпадают.|
|http: \/ \/ STS.contoso.com|http: \/ \/ contoso.com|Ложь.|Части данных о пользователе и узле не совпадают.|
|http: \/ \/ contoso.com|http: \/ \/ STS.contoso.com|Ложь.|Части данных о пользователе и узле не совпадают.|
