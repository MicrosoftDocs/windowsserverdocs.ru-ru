---
description: Дополнительные сведения о создании сервера федерации
...
-   Создание изолированного \- сервера федерации
    ...
    Дополнительные сведения о настройке автономного \- сервера федерации см. в разделе [Создание Stand-Alone сервера федерации](../../ad-fs/deployment/Create-a-Stand-Alone-Federation-Server.md).
