---
description: Дополнительные сведения о планировании емкости сервера AD FS
...
|Число запросов в секунду|Количество запросов, отправленных клиентами \( при общении с нагрузкой в системе \) или обработанными серверами \( при разговоре о пропускной способности сервера \) в секунду. Этот параметр используется в планировании емкости процессора и памяти сервера.|
...
-   **Потребление ресурсов ЦП:** процентное отношение, используемое для измерения емкости ЦП. Это позволяет определить общую загрузку ЦП в зависимости от числа входящих запросов на вход \- в секунду.
