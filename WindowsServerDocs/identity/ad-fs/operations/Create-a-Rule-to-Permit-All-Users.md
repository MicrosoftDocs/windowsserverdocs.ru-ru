...
![Снимок экрана, на котором показано, где можно выбрать отношения доверия с проверяющей стороной.](media/Create-a-Rule-to-Permit-All-Users/permitall1.PNG)
...
![Снимок экрана, на котором показано, где выбрать пункт изменить политику управления доступом.](media/Create-a-Rule-to-Permit-All-Users/permitall2.PNG)

4. На странице Политика контроля доступа выберите **разрешение все** , а затем нажмите кнопку **Применить** и **ОК**.
![Снимок экрана, на котором показана политика разрешения доступа ко всем пользователям.](media/Create-a-Rule-to-Permit-All-Users/permitall3.PNG)
...
![Снимок экрана, на котором показано, где выбрать пункт "изменить правила утверждений".](media/Create-a-Rule-to-Permit-All-Users/permitall4.PNG)
...
![Снимок экрана, на котором показана вкладка правил авторизации выдачи.](media/Create-a-Rule-to-Permit-All-Users/permitall5.PNG)
