---
description: 'Дополнительные сведения: Создание правила для отправки утверждения метода проверки подлинности'
...
![Снимок экрана, на котором показано, где можно выбрать отношения доверия с проверяющей стороной в дереве консоли при создании правила с помощью шаблона правила отправки членства в группе как утверждений.](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule9.PNG)

3.  Щелкните \- Выбранное отношение доверия правой кнопкой мыши и выберите пункт **изменить политику выдачи утверждений**.
![Снимок экрана, на котором показано, где выбрать пункт меню "изменить политику выдачи утверждений" при создании правила с помощью шаблона правила "Отправить членство в группе как утверждения".](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule10.PNG)
...
![Снимок экрана, показывающий, как добавить правило при создании правила с помощью шаблона правила "Отправить членство в группе как утверждения".](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule11.PNG)
...
![Снимок экрана, на котором показано, где выбрать шаблон "Отправить членство в группе как утверждение".](media/Create-a-Rule-to-Send-Group-Membership-as-a-Claim/group3.PNG)
...
![Снимок экрана, на котором показано, где выбрать Готово при создании правила с помощью шаблона правила отправки членства в группе в Windows Server 2016.](media/Create-a-Rule-to-Send-an-Authentication-Method-Claim/auth2.PNG)
...
![Снимок экрана, на котором показано, где выбрать отношения доверия поставщиков утверждений при создании правила с помощью шаблона правила "Отправить членство в группе как утверждения" в Windows Server 2016.](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule1.PNG)

3.  Щелкните \- Выбранное отношение доверия правой кнопкой мыши и выберите команду **изменить правила утверждений**.
![Снимок экрана, на котором показано, где выбрать параметр изменить правила утверждений при создании правила с помощью шаблона правила отправки членства в группах в Windows Server 2016.](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule2.PNG)
...
![Снимок экрана, на котором показано, где выбрать кнопку "добавить правило" при создании правила с помощью шаблона правила "Отправить членство в группе как утверждения" в Windows Server 2016.](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule3.PNG)

5.  На странице **Выбор шаблона правила** в разделе **шаблон правила утверждения** выберите **Отправить членство в группе как утверждение** из списка, а затем нажмите кнопку **Далее**.
![Снимок экрана, на котором показано, где выбрать шаблон "Отправить членство в группе как утверждение" при создании правила в Windows Server 2016.](media/Create-a-Rule-to-Send-Group-Membership-as-a-Claim/group3.PNG)
...
2.  В дереве консоли в разделе **AD FS** щелкните **отношения доверия с проверяющей стороной**.
![Снимок экрана, на котором показано, где выбрать отношения доверия проверяющей стороны в дереве консоли при создании правила с помощью шаблона преобразования входящего утверждения.](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule9.PNG)

3.  Щелкните \- Выбранное отношение доверия правой кнопкой мыши и выберите пункт **изменить политику выдачи утверждений**.
![Снимок экрана, на котором показано, где выбрать команду "изменить политику выдачи утверждений" при создании правила с помощью шаблона "Преобразование входящего правила утверждения".](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule10.PNG)

4.  В диалоговом окне **изменение политики выдачи утверждений** в разделе **правила преобразования выдачи** щелкните **Добавить правило** , чтобы запустить мастер правил.
![Снимок экрана, на котором показано, где выбрать пункт Добавить правило при создании правила с помощью шаблона преобразование входящего утверждения.](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule11.PNG)
...
![Снимок экрана, на котором показано, где выбрать преобразование входящего шаблона утверждения при создании правила.](media/Create-a-Rule-to-Transform-an-Incoming-Claim/transform3.PNG)
...
![Снимок экрана, на котором показано, где можно нажать кнопку Готово при создании правила с помощью шаблона преобразование входящего утверждения.](media/Create-a-Rule-to-Send-an-Authentication-Method-Claim/auth4.PNG)
...
2.  В дереве консоли в разделе **AD FS** щелкните **отношения доверия поставщиков утверждений**.
![Снимок экрана, на котором показано, где выбрать отношения доверия поставщиков утверждений в дереве консоли при создании правила с помощью шаблона преобразования входящего утверждения в Windows Server 2016.](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule1.PNG)

3.  Щелкните \- Выбранное отношение доверия правой кнопкой мыши и выберите команду **изменить правила утверждений**.
![Снимок экрана, на котором показано, где выбрать параметр изменить правила утверждений при создании правила с помощью шаблона преобразование входящего утверждения в Windows Server 2016.](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule2.PNG)

4.  В диалоговом окне **изменение правил утверждений** в разделе **правила преобразования принятия** нажмите кнопку **Добавить правило** , чтобы запустить мастер правил.
![Снимок экрана, на котором показано, где выбрать Добавление правила при создании правила с помощью шаблона преобразования входящего утверждения для утверждений в Windows Server 2016.](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule3.PNG)

5.  На странице **Выбор шаблона правила** в разделе **шаблон правила утверждения** выберите **преобразовать входящее утверждение** в список, а затем нажмите кнопку **Далее**.
![Снимок экрана, на котором показано, где выбрать шаблон преобразования входящего утверждения при создании правила в Windows Server 2016.](media/Create-a-Rule-to-Transform-an-Incoming-Claim/transform3.PNG)
...
![Снимок экрана, на котором показано, где можно выбрать Готово при создании правила с помощью шаблона преобразование входящего утверждения в Windows Server 2016.](media/Create-a-Rule-to-Send-an-Authentication-Method-Claim/auth4.PNG)
...
3.  Щелкните \- Выбранное отношение доверия правой кнопкой мыши и выберите команду **изменить правила утверждений**.
![Снимок экрана, на котором показано, где выбрать параметр изменить правила утверждений при создании правила с помощью шаблона правила отправки членства в группе как утверждений.](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule6.PNG)
...
4.  В диалоговом окне **изменение правил утверждений** выберите одну из следующих вкладок в зависимости от редактируемого отношения доверия и набора правил, в котором необходимо создать это правило, а затем нажмите кнопку **Добавить правило** , чтобы запустить мастер правил, связанный с этим набором правил:
    ...
    -    
 Правила ![ авторизации делегирования Снимок экрана, на котором показано, где можно выбрать Добавить правило при создании правила с помощью шаблона правила отправки членства в группе как утверждений.](media/Create-a-Rule-to-Permit-All-Users/permitall5.PNG)

5.  На странице **Выбор шаблона правила** в разделе **шаблон правила утверждения** выберите **Отправить членство в группе как утверждение** из списка, а затем нажмите кнопку **Далее**.
![Снимок экрана, на котором показано, где выбрать членство в группе отправки в качестве шаблона утверждения при создании правила.](media/Create-a-Rule-to-Send-Group-Membership-as-a-Claim/group1.PNG)
...
![Снимок экрана, на котором показано, где можно выбрать Готово при создании правила с помощью шаблона правила отправки членства в группе как утверждений.](media/Create-a-Rule-to-Send-an-Authentication-Method-Claim/auth1.PNG)
...
3.  Щелкните \- Выбранное отношение доверия правой кнопкой мыши и выберите команду **изменить правила утверждений**.
![Снимок экрана, на котором показано, где выбрать параметр изменить правила утверждений при создании правила с помощью шаблона преобразование входящего утверждения в Windows Server 2012 R2.](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule6.PNG)
...
4.  В диалоговом окне **изменение правил утверждений** выберите одну из следующих вкладок, которые зависят от редактируемого отношения доверия и набора правил, для которого необходимо создать это правило, а затем нажмите кнопку **Добавить правило** , чтобы запустить мастер правил, связанный с этим набором правил:
    ...
    -    
 Правила ![ авторизации делегирования Снимок экрана, на котором показано, где выбрать Добавление правила при создании правила с помощью шаблона преобразования входящего утверждения для утверждений в Windows Server 2012 R2.](media/Create-a-Rule-to-Permit-All-Users/permitall5.PNG)

5.  На странице **Выбор шаблона правила** в разделе **шаблон правила утверждения** выберите **преобразовать входящее утверждение** в список, а затем нажмите кнопку **Далее**.
![Снимок экрана, на котором показано, где выбрать шаблон преобразования входящего утверждения при создании правила в Windows Server 2012 R2.](media/Create-a-Rule-to-Transform-an-Incoming-Claim/transform1.PNG)
