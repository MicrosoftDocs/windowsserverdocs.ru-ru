...
![Снимок экрана, посвященный действию "Добавление отношения доверия поставщика утверждений".](media/Create-a-Claims-Provider-Trust/addclaim1.PNG)

3.  На странице **приветствия** нажмите кнопку **Начать**.
![Снимок экрана, на котором показана страница приветствия мастера добавления отношения доверия поставщика утверждений.](media/Create-a-Claims-Provider-Trust/addclaim2.PNG)
...
![Снимок экрана, на котором показано, что параметр "ввести отношение доверия поставщика утверждений" вручную.](media/Create-a-Claims-Provider-Trust/addclaim3.PNG)
...
![Снимок экрана, на котором показано, где указать отображаемое имя.](media/Create-a-Claims-Provider-Trust/addclaim4.PNG)

6.  На странице **Настройка URL-адреса** укажите **пассивный адрес URL WS-Federation** , если это применимо, и нажмите кнопку **Далее**.
![Снимок экрана, на котором показано, где указать WS-Federation пассивный U R L.](media/Create-a-Claims-Provider-Trust/addclaim5.PNG)
...
![Снимок экрана, на котором показано, куда добавить идентификатор доверия поставщика утверждений.](media/Create-a-Claims-Provider-Trust/addclaim6.PNG)
...
![Снимок экрана, на котором показано, как выбрать файл сертификата и добавить его в список сертификатов.](media/Create-a-Claims-Provider-Trust/addclaim7.PNG)
...
![Снимок экрана, показывающий, как сохранить сведения о доверии поставщика утверждений.](media/Create-a-Claims-Provider-Trust/addclaim8.PNG)
...
![Снимок экрана, на котором показано, как выбрать пункт Закрыть.](media/Create-a-Claims-Provider-Trust/addclaim9.PNG)
...
2.  В разделе **действия** щелкните **Добавить отношение доверия поставщика утверждений**.
![Снимок экрана, на котором показано, где можно выбрать добавить отношение доверия поставщика утверждений.](media/Create-a-Claims-Provider-Trust/addclaim1.PNG)
...
![Снимок экрана, на котором показаны данные импорта о поставщике утверждений, опубликованном в режиме "в сети" или в локальной сети.](media/Create-a-Claims-Provider-Trust/addclaim10.PNG)
