---
description: Дополнительные сведения см. в статье политики управления доступом в Windows Server 2016 AD FS
ms.assetid: 102eeeb1-6c55-42a2-b321-71a7dab46146
title: Политики управления доступом в AD FS Windows Server 2016
author: billmath
ms.author: billmath
manager: femila
ms.date: 05/31/2017
...
![Снимок экрана, на котором показано, где можно просмотреть политики управления доступом.](media/Access-Control-Policies-in-AD-FS/ADFSACP2.PNG)
...
![Снимок экрана, на котором показаны встроенные политики управления доступом.](media/Access-Control-Policies-in-AD-FS/ADFSACP3.PNG)
...
|Разрешение пользователям|Исключения|
| --- | --- |
...
![Снимок экрана, на котором показан пример параметризованного шаблона политики.](media/Access-Control-Policies-in-AD-FS/ADFSACP5.PNG)
...
![Снимок экрана, на котором показан пример непараметризованного шаблона политики.](media/Access-Control-Policies-in-AD-FS/ADFSACP4.PNG)
...
6.  Во всплывающем окне выберите **Проверка подлинности** в раскрывающемся списке.  Нажмите кнопку **ОК**.
    ...
    ![Снимок экрана, показывающий, как выбрать уровень доверия устройства.](media/Access-Control-Policies-in-AD-FS/ADFSACP6.PNG)

7.  Нажмите кнопку **ОК**. Нажмите кнопку **ОК**.

    ![Снимок экрана, показывающий, как принять изменение политики.](media/Access-Control-Policies-in-AD-FS/ADFSACP7.PNG)
...
6.  Во всплывающем окне выберите **параметр, указанный при назначении политики контроля доступа**.  Нажмите кнопку **ОК**.
    ...
    ![Снимок экрана, на котором показан параметр, указанный при назначении политики управления доступом.](media/Access-Control-Policies-in-AD-FS/ADFSACP8.PNG)

7.  Нажмите кнопку **ОК**. Нажмите кнопку **ОК**.

    ![Снимок экрана, показывающий, как принять выбранный параметр.](media/Access-Control-Policies-in-AD-FS/ADFSACP9.PNG)
...
10. Нажмите кнопку **ОК**. Нажмите кнопку **ОК**.
    ...
    ![Снимок экрана, показывающий диалоговое окно редактора экрана.](media/Access-Control-Policies-in-AD-FS/ADFSACP10.PNG)
...
![Снимок экрана, на котором показан экран Выбор политики управления доступом.](media/Access-Control-Policies-in-AD-FS/ADFSACP13.PNG)
...
![Снимок экрана, показывающий повторное выполнение приложения доверия сторон.](media/Access-Control-Policies-in-AD-FS/ADFSACP14.PNG)

Здесь можно выбрать политику управления доступом и применить ее к приложению.

![Снимок экрана, показывающий, как изменить политику управления доступом.](media/Access-Control-Policies-in-AD-FS/ADFSACP15.PNG)
