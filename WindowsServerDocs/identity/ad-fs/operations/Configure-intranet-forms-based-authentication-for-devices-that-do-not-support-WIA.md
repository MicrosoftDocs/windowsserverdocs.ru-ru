---
description: Дополнительные сведения о настройке проверки подлинности на основе форм интрасети для устройств, которые не поддерживают WIA
