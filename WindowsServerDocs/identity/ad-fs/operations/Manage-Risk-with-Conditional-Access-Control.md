---
description: 'Дополнительные сведения: управление рисками с помощью управления условным доступом'
...
|Имя участника-пользователя|Имя участника-пользователя (UPN) этого пользователя.|
