---
description: 'Дополнительные сведения: настройка AD FS для проверки подлинности пользователей, хранящихся в каталогах LDAP в Windows Server 2016 или более поздней версии'
...
WS-Trust активный протокол авторизации также поддерживается для удостоверений, которые хранятся в каталогах LDAP.
