---
description: 'Дополнительные сведения: Создание правила для отправки членства в группе в качестве утверждения'
...
![Снимок экрана, на котором показано, где выбрать отношения доверия с проверяющей стороной при создании правила для отправки членства в группе в качестве утверждения на отношение доверия с проверяющей стороной в Windows Server 2016.](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule9.PNG)

3.  Щелкните \- Выбранное отношение доверия правой кнопкой мыши и выберите пункт **изменить политику выдачи утверждений**.
![Снимок экрана, на котором показано, где выбрать пункт "изменить политику выдачи утверждений" при создании правила для отправки членства в группе в качестве утверждения на отношение доверия с проверяющей стороной в Windows Server 2016.](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule10.PNG)
...
![Снимок экрана, на котором показано, где выбрать Добавление правила при создании правила для отправки членства в группе в качестве утверждения на отношение доверия с проверяющей стороной в Windows Server 2016.](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule11.PNG)
...
![Снимок экрана, на котором показано, где выбрать шаблон "Отправить членство в группе как утверждение" при создании правила для отправки членства в группе в качестве утверждения на отношение доверия с проверяющей стороной в Windows Server 2016.](media/Create-a-Rule-to-Send-Group-Membership-as-a-Claim/group3.PNG)
...
![Снимок экрана, на котором показано, где ввести имя правила утверждения при создании правила для отправки членства в группе в качестве утверждения на отношение доверия с проверяющей стороной в Windows Server 2016.](media/Create-a-Rule-to-Send-Group-Membership-as-a-Claim/group4.PNG)
...
![Снимок экрана, на котором показано, где выбрать отношения доверия поставщиков утверждений при создании правила для отправки членства в группе в качестве утверждения на отношение доверия поставщика утверждений в Windows Server 2016.](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule1.PNG)

3.  Щелкните \- Выбранное отношение доверия правой кнопкой мыши и выберите команду **изменить правила утверждений**.
![Снимок экрана, на котором показано, где выбрать параметр изменить правила утверждений при создании правила для отправки членства в группе в качестве утверждения на отношение доверия поставщика утверждений в Windows Server 2016.](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule2.PNG)
...
![Снимок экрана, на котором показано, где выбрать Добавление правила при создании правила для отправки членства в группе в качестве утверждения для отношения доверия с поставщиком утверждений в Windows Server 2016.](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule3.PNG)

5.  На странице **Выбор шаблона правила** в разделе **шаблон правила утверждения** выберите **Отправить членство в группе как утверждение** из списка, а затем нажмите кнопку **Далее**.
![Снимок экрана, на котором показано, где выбрать шаблон "Отправить членство в группе как утверждение" при создании правила для отправки членства в группе в качестве утверждения на отношение доверия поставщика утверждений в Windows Server 2016.](media/Create-a-Rule-to-Send-Group-Membership-as-a-Claim/group3.PNG)

6.   На странице **Настройка правила** в разделе **имя правила утверждения** введите отображаемое имя для этого правила, в **группе пользователь** нажмите кнопку **Обзор** и выберите группу, в разделе **Тип исходящего утверждения** выберите нужный тип утверждения, а затем в поле **Тип исходящего утверждения** введите значение.
![Снимок экрана, на котором показано, где ввести имя правила утверждения при создании правила для отправки членства в группе в качестве утверждения на отношение доверия поставщика утверждений в Windows Server 2016.](media/Create-a-Rule-to-Send-Group-Membership-as-a-Claim/group4.PNG)
...
3.  Щелкните \- Выбранное отношение доверия правой кнопкой мыши и выберите команду **изменить правила утверждений**.
![Снимок экрана, на котором показано, где выбрать параметр изменить правила утверждений при создании правила для отправки членства в группе в Windows Server 2012 R2 в качестве утверждения.](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule6.PNG)
...
5.  На странице **Выбор шаблона правила** в разделе **шаблон правила утверждения** выберите **Отправить членство в группе как утверждение** из списка, а затем нажмите кнопку **Далее**.
![Снимок экрана, на котором показано, где выбрать параметр Отправить членство в группе в качестве шаблона утверждения при создании правила для отправки членства в группе в качестве утверждения в Windows Server 2012 R2.](media/Create-a-Rule-to-Send-Group-Membership-as-a-Claim/group1.PNG)

6.  На странице **Настройка правила** в разделе **имя правила утверждения** введите отображаемое имя для этого правила, в **группе пользователь** нажмите кнопку **Обзор** и выберите группу, в разделе **Тип исходящего утверждения** выберите нужный тип утверждения, а затем в поле **Тип исходящего утверждения** введите значение.
![Снимок экрана, на котором показано, где ввести имя правила утверждения при создании правила для отправки членства в группе в Windows Server 2012 R2 в качестве утверждения.](media/Create-a-Rule-to-Send-Group-Membership-as-a-Claim/group2.PNG)
