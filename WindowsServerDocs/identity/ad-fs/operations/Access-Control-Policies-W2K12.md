---
description: Дополнительные сведения см. в статье политики управления доступом в Windows Server 2012 R2 и Windows Server 2012 AD FS
ms.assetid: 5728847d-dcef-4694-9080-d63bfb1fe24b
title: Политики управления доступом в AD FS в Windows Server 2012 R2
author: billmath
ms.author: billmath
manager: femila
ms.date: 06/05/2018
...
11. Чтобы сохранить новые правила, в диалоговом окне **изменение правил утверждений** нажмите кнопку **ОК**. Полученный список должен выглядеть следующим образом.
    ...
    ![Снимок экрана, на котором показано диалоговое окно "изменение правил утверждений".](media/Access-Control-Policies-W2K12/clientaccess3.png)
