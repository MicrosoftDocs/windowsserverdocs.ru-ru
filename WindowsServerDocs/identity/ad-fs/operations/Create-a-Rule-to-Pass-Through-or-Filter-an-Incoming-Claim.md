---
description: 'Дополнительные сведения: Создание правила для передачи или фильтрации входящего утверждения'
...
![Снимок экрана, в котором показаны отношения доверия с проверяющей стороной в дереве консоли.](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule9.PNG)

3.  Щелкните \- Выбранное отношение доверия правой кнопкой мыши и выберите пункт **изменить политику выдачи утверждений**.
![Снимок экрана, посвященный параметру меню "изменить политику выдачи утверждений".](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule10.PNG)
...
![Снимок экрана, на котором показана вкладка Правила преобразования выдачи.](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule11.PNG)
...
![Снимок экрана, на котором показано, куда выбрать шаблон входящего утверждения или выполнить его фильтрацию.](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule4.PNG)
...
6.  На странице **Настройка правила** в разделе **имя правила утверждения** введите отображаемое имя для этого правила, в поле **тип входящего утверждения** выберите тип утверждения в списке, а затем выберите один из следующих вариантов в зависимости от потребностей Организации.
 ...
 ![ Снимок экрана, на котором показано, где выбрать тип входящего утверждения.](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule5.PNG)
...
![Снимок экрана, в котором показаны отношения доверия поставщиков утверждений в дереве консоли.](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule1.PNG)

3.  Щелкните \- Выбранное отношение доверия правой кнопкой мыши и выберите команду **изменить правила утверждений**.
![Снимок экрана, посвященный параметру меню "изменить правила утверждений".](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule2.PNG)
...
![Снимок экрана, на котором показана вкладка Правила преобразования приема.](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule3.PNG)

5.  На странице **Выбор шаблона правила** в разделе **шаблон правила утверждения** выберите **передать или отфильтровать входящее утверждение** из списка, а затем нажмите кнопку **Далее**.
![Снимок экрана, на котором показано, где выбрать шаблон правила.](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule4.PNG)
...
6.  На странице **Настройка правила** в разделе **имя правила утверждения** введите отображаемое имя для этого правила, в поле **тип входящего утверждения** выберите тип утверждения в списке, а затем выберите один из следующих вариантов в зависимости от потребностей Организации.
    ...
    -   **Проходить только по значениям утверждений, начинающимся с определенного значения** 
 ![ Снимок экрана, на котором показано, где в AD указано имя правила утверждения.](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule5.PNG)
...
3.  Щелкните \- Выбранное отношение доверия правой кнопкой мыши и выберите команду **изменить правила утверждений**.
![Снимок экрана, на котором показано, где выбрать пункт "изменить правила утверждений".](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule6.PNG)
...
4.  В диалоговом окне **изменение правил утверждений** выберите одну из следующих вкладок в зависимости от редактируемого отношения доверия и набора правил, в котором необходимо создать это правило, а затем нажмите кнопку **Добавить правило** , чтобы запустить мастер правил, связанный с этим набором правил:
    ...
    -    
 Правила ![ авторизации делегирования Сцееншот, на котором отображается кнопка Добавить правило.](media/Create-a-Rule-to-Permit-All-Users/permitall5.PNG)

5.  На странице **Выбор шаблона правила** в разделе **шаблон правила утверждения** выберите **передать или отфильтровать входящее утверждение** из списка, а затем нажмите кнопку **Далее**.
![Снимок экрана, на котором показан экран выбора типа правила.](media/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim/claimrule7.PNG)
...
[Когда следует использовать правило пропуска или фильтрации утверждений](../../ad-fs/technical-reference/When-to-Use-a-Pass-Through-or-Filter-Claim-Rule.md)
