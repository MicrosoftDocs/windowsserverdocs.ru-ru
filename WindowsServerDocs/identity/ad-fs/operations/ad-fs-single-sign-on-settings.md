---
description: 'Дополнительные сведения: AD FS параметры одного Sign-On'
...
ms.locfileid: "97041922"
---
# <a name="ad-fs-single-sign-on-settings"></a>AD FS параметры одного Sign-On
...
## <a name="supported-types-of-single-sign-on"></a>Поддерживаемые типы отдельных Sign-On
...
## <a name="ad-fs-2016---single-sign-on-and-authenticated-devices"></a>AD FS 2016-одно Sign-On и устройства с проверкой подлинности
...
После первого предоставления учетных данных пользователи по умолчанию с зарегистрированными устройствами получают один Sign-On в течение максимального периода в 90 дней, при условии, что они используют устройство для доступа к ресурсам AD FS по крайней мере раз в 14 дней.  Если после предоставления учетных данных они ожидают 15 дней, пользователи снова получат запрос на ввод учетных данных.
