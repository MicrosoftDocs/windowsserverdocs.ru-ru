...
Это часть расширенного плана, так как для агрегирования, создания и настройки оповещений в сведениях о безопасности и управлении событиями (SIEM) требуются квалифицированные аналитики (в отличие от Azure ATP в 30-дневном плане, который включает в себя возможности оповещения без дополнительной настройки).
